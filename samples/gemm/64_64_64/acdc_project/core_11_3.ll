...
define void @core113() !dbg !3 {
  ...
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([32 x [32 x i32]]* @buf16 to i64), i64 31), i64 0)), !dbg !11
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([32 x [32 x i32]]* @buf17 to i64), i64 31), i64 0)), !dbg !12
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([32 x [32 x i32]]* @buf18 to i64), i64 31), i64 0)), !dbg !13
  ...
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([32 x [32 x i32]]* @buf22 to i64), i64 31), i64 0)), !dbg !17
  call void @llvm.aie.lock.acquire.reg(i32 51, i32 1), !dbg !18
  call void @llvm.aie.lock.acquire.reg(i32 50, i32 1), !dbg !19
  call void @llvm.aie.lock.acquire.reg(i32 48, i32 1), !dbg !20
  call void @llvm.aie.lock.acquire.reg(i32 49, i32 0), !dbg !21
  call void @extern_kernel(i32* getelementptr inbounds ([32 x [32 x i32]], [32 x [32 x i32]]* @buf19, i64 0, i64 0, i64 0), i32* getelementptr inbounds ([32 x [32 x i32]], [32 x [32 x i32]]* @buf23, i64 0, i64 0, i64 0), i32* getelementptr inbounds ([32 x [32 x i32]], [32 x [32 x i32]]* @buf24, i64 0, i64 0, i64 0), i32* getelementptr inbounds ([32 x [32 x i32]], [32 x [32 x i32]]* @buf25, i64 0, i64 0, i64 0)), !dbg !22
  call void @llvm.aie.lock.release.reg(i32 49, i32 1), !dbg !23
  call void @llvm.aie.lock.release.reg(i32 48, i32 0), !dbg !24
...
!3 = distinct !DISubprogram(name: "core113", linkageName: "core113", scope: null, file: !4, line: 24, type: !5, scopeLine: 24, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !6)
!4 = !DIFile(filename: "acdc_project/core_11_3.opt.mlir", directory: "/proj/rdi/staff/jinmingz/nobkup/polyaie/samples/gemm/64_64_64")
