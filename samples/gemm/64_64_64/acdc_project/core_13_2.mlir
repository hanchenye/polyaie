module @gemm attributes {llvm.target_triple = "aie"} {
  ...
  func @core132() {
    %0 = memref.get_global @buf33 : memref<32x32xi32>
    memref.assume_alignment %0, 32 : memref<32x32xi32>
    %1 = memref.get_global @buf34 : memref<32x32xi32>
    memref.assume_alignment %1, 32 : memref<32x32xi32>
    %2 = memref.get_global @buf35 : memref<32x32xi32>
    memref.assume_alignment %2, 32 : memref<32x32xi32>
    %3 = memref.get_global @buf36 : memref<32x32xi32>
    ...
    %8 = arith.index_cast %c17 : index to i32
    %c1_i32_0 = arith.constant 1 : i32
    call @llvm.aie.lock.acquire.reg(%8, %c1_i32_0) : (i32, i32) -> ()
    %9 = arith.index_cast %c33 : index to i32
    ...
    %10 = arith.index_cast %c33 : index to i32
