module @gemm attributes {llvm.target_triple = "aie"} {
  ...
  func @core113() {
    ...
    %3 = memref.get_global @buf16 : memref<32x32xi32>
    memref.assume_alignment %3, 32 : memref<32x32xi32>
    %4 = memref.get_global @buf17 : memref<32x32xi32>
    memref.assume_alignment %4, 32 : memref<32x32xi32>
    %5 = memref.get_global @buf18 : memref<32x32xi32>
    ...
    %9 = memref.get_global @buf22 : memref<32x32xi32>
    ...
    %12 = arith.index_cast %c48 : index to i32
