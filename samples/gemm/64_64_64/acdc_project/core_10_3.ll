...
define void @core103() !dbg !3 {
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([32 x [32 x i32]]* @buf16 to i64), i64 31), i64 0)), !dbg !7
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([32 x [32 x i32]]* @buf17 to i64), i64 31), i64 0)), !dbg !9
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([32 x [32 x i32]]* @buf18 to i64), i64 31), i64 0)), !dbg !10
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([32 x [32 x i32]]* @buf12 to i64), i64 31), i64 0)), !dbg !11
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([32 x [32 x i32]]* @buf13 to i64), i64 31), i64 0)), !dbg !12
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([32 x [32 x i32]]* @buf14 to i64), i64 31), i64 0)), !dbg !13
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([32 x [32 x i32]]* @buf15 to i64), i64 31), i64 0)), !dbg !14
  call void @llvm.aie.lock.acquire.reg(i32 51, i32 1), !dbg !15
  call void @llvm.aie.lock.acquire.reg(i32 48, i32 0), !dbg !16
  call void @llvm.aie.lock.acquire.reg(i32 50, i32 1), !dbg !17
  call void @llvm.aie.lock.acquire.reg(i32 49, i32 1), !dbg !18
  call void @extern_kernel(i32* getelementptr inbounds ([32 x [32 x i32]], [32 x [32 x i32]]* @buf12, i64 0, i64 0, i64 0), i32* getelementptr inbounds ([32 x [32 x i32]], [32 x [32 x i32]]* @buf16, i64 0, i64 0, i64 0), i32* getelementptr inbounds ([32 x [32 x i32]], [32 x [32 x i32]]* @buf17, i64 0, i64 0, i64 0), i32* getelementptr inbounds ([32 x [32 x i32]], [32 x [32 x i32]]* @buf18, i64 0, i64 0, i64 0)), !dbg !19
  call void @llvm.aie.lock.release.reg(i32 49, i32 0), !dbg !20
  call void @llvm.aie.lock.release.reg(i32 50, i32 0), !dbg !21
  call void @llvm.aie.lock.release.reg(i32 48, i32 1), !dbg !22
  call void @llvm.aie.lock.release.reg(i32 51, i32 0), !dbg !23
  call void @llvm.aie.lock.release.reg(i32 63, i32 1), !dbg !24
  ret void, !dbg !25
}

define void @_main() !dbg !26 {
  call void @core103(), !dbg !27
  ret void, !dbg !29
}
...
!3 = distinct !DISubprogram(name: "core103", linkageName: "core103", scope: null, file: !4, line: 21, type: !5, scopeLine: 21, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !6)
!4 = !DIFile(filename: "acdc_project/core_10_3.opt.mlir", directory: "/proj/rdi/staff/jinmingz/nobkup/polyaie/samples/gemm/64_64_64")
