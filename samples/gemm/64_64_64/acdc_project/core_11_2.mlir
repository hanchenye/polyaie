module @gemm attributes {llvm.target_triple = "aie"} {
  ...
  func @core112() {
    %0 = memref.get_global @buf26 : memref<32x32xi32>
    memref.assume_alignment %0, 32 : memref<32x32xi32>
    %1 = memref.get_global @buf27 : memref<32x32xi32>
    memref.assume_alignment %1, 32 : memref<32x32xi32>
    %2 = memref.get_global @buf28 : memref<32x32xi32>
    memref.assume_alignment %2, 32 : memref<32x32xi32>
    %3 = memref.get_global @buf29 : memref<32x32xi32>
    ...
    %6 = memref.get_global @buf25 : memref<32x32xi32>
    ...
    %10 = memref.get_global @buf22 : memref<32x32xi32>
