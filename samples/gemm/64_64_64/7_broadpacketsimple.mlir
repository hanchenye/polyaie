module @gemm {
  ...
  AIE.packet_flow(1) {
    ...
    AIE.packet_dest<%78, DMA : 1>
    AIE.packet_dest<%97, DMA : 1>
  }
  AIE.packet_flow(0) {
    AIE.packet_source<%14, DMA : 1>
    AIE.packet_dest<%69, DMA : 1>
