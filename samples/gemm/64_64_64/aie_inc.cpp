...
void mlir_aie_configure_dmas(aie_libxaie_ctx_t *ctx) {
  ...
  XAieDma_TileBdSetLock(&(ctx->TileDMAInst[10][3]), /* bd */ 2,
                        XAIEDMA_TILE_BD_ADDRA, /* lockID */ 0, XAIE_ENABLE,
                        /* release */ 0, XAIE_ENABLE, /* acquire */ 1);
  XAieDma_TileBdSetAdrLenMod(&(ctx->TileDMAInst[10][3]), /* bd */ 2,
                             /* addrA */ 0x1000, /* addrB */ 0x0,
                             /* len */ 1024 * 4, /* ABMode */ XAIE_DISABLE,
                             /* FIFOMode */ XAIE_DISABLE);
  XAieDma_TileBdSetNext(&(ctx->TileDMAInst[10][3]), /* bd */ 2, /* nextbd */ 2);
  XAieDma_TileBdSetPkt(&(ctx->TileDMAInst[10][3]), /* bd */ 2, /* en */ 1,
                       /* type */ 0, /* id */ 0);
  XAieDma_TileBdWrite(&(ctx->TileDMAInst[10][3]), /* bd */ 2);
  ...
  XAieDma_TileChControl(&(ctx->TileDMAInst[10][3]), XAIEDMA_TILE_CHNUM_S2MM1,
                        XAIE_RESETDISABLE, XAIE_ENABLE);
  XAieDma_TileSetStartBd((&(ctx->TileDMAInst[10][3])), XAIEDMA_TILE_CHNUM_MM2S0,
                         /* bd */ 2);
  XAieDma_TileChControl(&(ctx->TileDMAInst[10][3]), XAIEDMA_TILE_CHNUM_MM2S0,
                        XAIE_RESETDISABLE, XAIE_ENABLE);
  ...
  XAieDma_TileBdSetLock(&(ctx->TileDMAInst[11][3]), /* bd */ 2,
                        XAIEDMA_TILE_BD_ADDRA, /* lockID */ 1, XAIE_ENABLE,
                        /* release */ 0, XAIE_ENABLE, /* acquire */ 1);
  XAieDma_TileBdSetAdrLenMod(&(ctx->TileDMAInst[11][3]), /* bd */ 2,
                             /* addrA */ 0x1000, /* addrB */ 0x0,
                             /* len */ 1024 * 4, /* ABMode */ XAIE_DISABLE,
                             /* FIFOMode */ XAIE_DISABLE);
  XAieDma_TileBdSetNext(&(ctx->TileDMAInst[11][3]), /* bd */ 2, /* nextbd */ 2);
  XAieDma_TileBdSetPkt(&(ctx->TileDMAInst[11][3]), /* bd */ 2, /* en */ 1,
                       /* type */ 0, /* id */ 1);
  XAieDma_TileBdWrite(&(ctx->TileDMAInst[11][3]), /* bd */ 2);
  ...
  XAieDma_TileChControl(&(ctx->TileDMAInst[11][3]), XAIEDMA_TILE_CHNUM_S2MM1,
                        XAIE_RESETDISABLE, XAIE_ENABLE);
  XAieDma_TileSetStartBd((&(ctx->TileDMAInst[11][3])), XAIEDMA_TILE_CHNUM_MM2S0,
                         /* bd */ 2);
  XAieDma_TileChControl(&(ctx->TileDMAInst[11][3]), XAIEDMA_TILE_CHNUM_MM2S0,
                        XAIE_RESETDISABLE, XAIE_ENABLE);
  ...
  XAieDma_TileBdSetLock(&(ctx->TileDMAInst[12][3]), /* bd */ 2,
                        XAIEDMA_TILE_BD_ADDRA, /* lockID */ 1, XAIE_ENABLE,
                        /* release */ 0, XAIE_ENABLE, /* acquire */ 1);
  XAieDma_TileBdSetAdrLenMod(&(ctx->TileDMAInst[12][3]), /* bd */ 2,
                             /* addrA */ 0x1000, /* addrB */ 0x0,
                             /* len */ 1024 * 4, /* ABMode */ XAIE_DISABLE,
                             /* FIFOMode */ XAIE_DISABLE);
  XAieDma_TileBdSetNext(&(ctx->TileDMAInst[12][3]), /* bd */ 2, /* nextbd */ 2);
  XAieDma_TileBdSetPkt(&(ctx->TileDMAInst[12][3]), /* bd */ 2, /* en */ 1,
                       /* type */ 0, /* id */ 2);
  XAieDma_TileBdWrite(&(ctx->TileDMAInst[12][3]), /* bd */ 2);
  ...
  XAieDma_TileChControl(&(ctx->TileDMAInst[12][3]), XAIEDMA_TILE_CHNUM_S2MM1,
                        XAIE_RESETDISABLE, XAIE_ENABLE);
  XAieDma_TileSetStartBd((&(ctx->TileDMAInst[12][3])), XAIEDMA_TILE_CHNUM_MM2S0,
                         /* bd */ 2);
  XAieDma_TileChControl(&(ctx->TileDMAInst[12][3]), XAIEDMA_TILE_CHNUM_MM2S0,
                        XAIE_RESETDISABLE, XAIE_ENABLE);
  ...
  XAieDma_TileBdSetPkt(&(ctx->TileDMAInst[13][2]), /* bd */ 0, /* en */ 1,
                       /* type */ 0, /* id */ 4);
  ...
  XAieDma_TileBdSetPkt(&(ctx->TileDMAInst[13][2]), /* bd */ 1, /* en */ 1,
                       /* type */ 0, /* id */ 0);
  ...
  XAieDma_TileBdSetPkt(&(ctx->TileDMAInst[13][3]), /* bd */ 0, /* en */ 1,
                       /* type */ 0, /* id */ 5);
  ...
  XAieDma_TileBdSetPkt(&(ctx->TileDMAInst[13][3]), /* bd */ 1, /* en */ 1,
                       /* type */ 0, /* id */ 1);
  XAieDma_TileBdWrite(&(ctx->TileDMAInst[13][3]), /* bd */ 1);
  XAieDma_TileBdSetLock(&(ctx->TileDMAInst[13][3]), /* bd */ 2,
                        XAIEDMA_TILE_BD_ADDRA, /* lockID */ 0, XAIE_ENABLE,
                        /* release */ 0, XAIE_ENABLE, /* acquire */ 1);
  XAieDma_TileBdSetAdrLenMod(&(ctx->TileDMAInst[13][3]), /* bd */ 2,
                             /* addrA */ 0x1000, /* addrB */ 0x0,
                             /* len */ 1024 * 4, /* ABMode */ XAIE_DISABLE,
                             /* FIFOMode */ XAIE_DISABLE);
  XAieDma_TileBdSetNext(&(ctx->TileDMAInst[13][3]), /* bd */ 2, /* nextbd */ 2);
  XAieDma_TileBdSetPkt(&(ctx->TileDMAInst[13][3]), /* bd */ 2, /* en */ 1,
                       /* type */ 0, /* id */ 3);
  XAieDma_TileBdWrite(&(ctx->TileDMAInst[13][3]), /* bd */ 2);
  ...
  XAieDma_TileChControl(&(ctx->TileDMAInst[13][3]), XAIEDMA_TILE_CHNUM_S2MM1,
                        XAIE_RESETDISABLE, XAIE_ENABLE);
  XAieDma_TileSetStartBd((&(ctx->TileDMAInst[13][3])), XAIEDMA_TILE_CHNUM_MM2S0,
                         /* bd */ 2);
  XAieDma_TileChControl(&(ctx->TileDMAInst[13][3]), XAIEDMA_TILE_CHNUM_MM2S0,
                        XAIE_RESETDISABLE, XAIE_ENABLE);
  ...
  XAieDma_ShimBdSetLock(&ShimDMAInst_10_0, /* bd */ 0, /* lockID */ 0,
                        XAIE_ENABLE, /* release */ 0, XAIE_ENABLE,
                        /* acquire */ 1);
  XAieDma_ShimBdSetAddr(&ShimDMAInst_10_0, /* bd */ 0, HIGH_ADDR((u64)0x6000),
  ...
  XAieDma_ShimBdSetLock(&ShimDMAInst_10_0, /* bd */ 1, /* lockID */ 3,
                        XAIE_ENABLE, /* release */ 0, XAIE_ENABLE,
                        /* acquire */ 1);
  XAieDma_ShimBdSetAddr(&ShimDMAInst_10_0, /* bd */ 1, HIGH_ADDR((u64)0x4000),
                        LOW_ADDR((u64)0x4000), /* len */ 1024 * 4);
  XAieDma_ShimBdSetAxi(&ShimDMAInst_10_0, /* bd */ 1, /* smid */ 0,
                       /* burstlen */ 4, /* QOS */ 0, /* Cache */ 0,
                       /* secure */ XAIE_ENABLE);
  XAieDma_ShimBdSetNext(&ShimDMAInst_10_0, /* bd */ 1, /* nextbd */ 0);
  XAieDma_ShimBdSetPkt(&ShimDMAInst_10_0, /* bd */ 1, /* en */ 1, /* type */ 0,
                       /* id */ 1);
  XAieDma_ShimBdWrite(&ShimDMAInst_10_0, /* bd */ 1);
  XAieDma_ShimBdSetLock(&ShimDMAInst_10_0, /* bd */ 2, /* lockID */ 1,
                        XAIE_ENABLE, /* release */ 0, XAIE_ENABLE,
                        /* acquire */ 1);
  XAieDma_ShimBdSetAddr(&ShimDMAInst_10_0, /* bd */ 2, HIGH_ADDR((u64)0x7000),
  ...
  XAieDma_ShimBdSetLock(&ShimDMAInst_10_0, /* bd */ 3, /* lockID */ 2,
                        XAIE_ENABLE, /* release */ 0, XAIE_ENABLE,
                        /* acquire */ 1);
  XAieDma_ShimBdSetAddr(&ShimDMAInst_10_0, /* bd */ 3, HIGH_ADDR((u64)0x5000),
                        LOW_ADDR((u64)0x5000), /* len */ 1024 * 4);
  XAieDma_ShimBdSetAxi(&ShimDMAInst_10_0, /* bd */ 3, /* smid */ 0,
                       /* burstlen */ 4, /* QOS */ 0, /* Cache */ 0,
                       /* secure */ XAIE_ENABLE);
  XAieDma_ShimBdSetNext(&ShimDMAInst_10_0, /* bd */ 3, /* nextbd */ 2);
  ...
  XAieDma_ShimBdSetAddr(&ShimDMAInst_11_0, /* bd */ 0, HIGH_ADDR((u64)0xC000),
                        LOW_ADDR((u64)0xC000), /* len */ 1025 * 4);
  ...
  XAieDma_ShimBdSetAddr(&ShimDMAInst_11_0, /* bd */ 1, HIGH_ADDR((u64)0xE000),
                        LOW_ADDR((u64)0xE000), /* len */ 1025 * 4);
  ...
  XAieDma_ShimBdSetAddr(&ShimDMAInst_11_0, /* bd */ 2, HIGH_ADDR((u64)0x10000),
  ...
  XAieDma_ShimBdSetAddr(&ShimDMAInst_11_0, /* bd */ 3, HIGH_ADDR((u64)0x12000),
                        LOW_ADDR((u64)0x12000), /* len */ 1025 * 4);
  XAieDma_ShimBdSetAxi(&ShimDMAInst_11_0, /* bd */ 3, /* smid */ 0,
                       /* burstlen */ 4, /* QOS */ 0, /* Cache */ 0,
                       /* secure */ XAIE_ENABLE);
  XAieDma_ShimBdSetNext(&ShimDMAInst_11_0, /* bd */ 3, /* nextbd */ 0);
  XAieDma_ShimBdSetPkt(&ShimDMAInst_11_0, /* bd */ 3, /* en */ 1, /* type */ 0,
                       /* id */ 3);
  XAieDma_ShimBdWrite(&ShimDMAInst_11_0, /* bd */ 3);
  XAieDma_ShimBdSetLock(&ShimDMAInst_11_0, /* bd */ 4, /* lockID */ 3,
                        XAIE_ENABLE, /* release */ 0, XAIE_ENABLE,
                        /* acquire */ 1);
  XAieDma_ShimBdSetAddr(&ShimDMAInst_11_0, /* bd */ 4, HIGH_ADDR((u64)0xB000),
  ...
  XAieDma_ShimBdSetLock(&ShimDMAInst_11_0, /* bd */ 5, /* lockID */ 1,
                        XAIE_ENABLE, /* release */ 0, XAIE_ENABLE,
                        /* acquire */ 1);
  XAieDma_ShimBdSetAddr(&ShimDMAInst_11_0, /* bd */ 5, HIGH_ADDR((u64)0xA000),
                        LOW_ADDR((u64)0xA000), /* len */ 1024 * 4);
  XAieDma_ShimBdSetAxi(&ShimDMAInst_11_0, /* bd */ 5, /* smid */ 0,
                       /* burstlen */ 4, /* QOS */ 0, /* Cache */ 0,
                       /* secure */ XAIE_ENABLE);
  XAieDma_ShimBdSetNext(&ShimDMAInst_11_0, /* bd */ 5, /* nextbd */ 4);
  XAieDma_ShimBdSetPkt(&ShimDMAInst_11_0, /* bd */ 5, /* en */ 1, /* type */ 0,
                       /* id */ 5);
  XAieDma_ShimBdWrite(&ShimDMAInst_11_0, /* bd */ 5);
  XAieDma_ShimBdSetLock(&ShimDMAInst_11_0, /* bd */ 6, /* lockID */ 0,
                        XAIE_ENABLE, /* release */ 0, XAIE_ENABLE,
                        /* acquire */ 1);
  XAieDma_ShimBdSetAddr(&ShimDMAInst_11_0, /* bd */ 6, HIGH_ADDR((u64)0x9000),
  ...
  XAieDma_ShimBdSetLock(&ShimDMAInst_11_0, /* bd */ 7, /* lockID */ 2,
                        XAIE_ENABLE, /* release */ 0, XAIE_ENABLE,
                        /* acquire */ 1);
  XAieDma_ShimBdSetAddr(&ShimDMAInst_11_0, /* bd */ 7, HIGH_ADDR((u64)0x8000),
                        LOW_ADDR((u64)0x8000), /* len */ 1024 * 4);
  XAieDma_ShimBdSetAxi(&ShimDMAInst_11_0, /* bd */ 7, /* smid */ 0,
                       /* burstlen */ 4, /* QOS */ 0, /* Cache */ 0,
                       /* secure */ XAIE_ENABLE);
  XAieDma_ShimBdSetNext(&ShimDMAInst_11_0, /* bd */ 7, /* nextbd */ 6);
...
int32_t mlir_aie_read_buffer_buf12(aie_libxaie_ctx_t *ctx, int index) {
  int32_t value =
      XAieTile_DmReadWord(&(ctx->TileInst[10][2]), buf12_offset + (index * 4));
  return value;
}
...
int32_t mlir_aie_read_buffer_buf13(aie_libxaie_ctx_t *ctx, int index) {
  int32_t value =
      XAieTile_DmReadWord(&(ctx->TileInst[10][2]), buf13_offset + (index * 4));
  return value;
}
...
int32_t mlir_aie_read_buffer_buf14(aie_libxaie_ctx_t *ctx, int index) {
  int32_t value =
      XAieTile_DmReadWord(&(ctx->TileInst[10][2]), buf14_offset + (index * 4));
  return value;
}
...
const int buf23_offset = 4096;
int32_t mlir_aie_read_buffer_buf23(aie_libxaie_ctx_t *ctx, int index) {
  int32_t value =
      XAieTile_DmReadWord(&(ctx->TileInst[11][3]), buf23_offset + (index * 4));
  return value;
}
...
const int buf24_offset = 8192;
int32_t mlir_aie_read_buffer_buf24(aie_libxaie_ctx_t *ctx, int index) {
  int32_t value =
      XAieTile_DmReadWord(&(ctx->TileInst[11][3]), buf24_offset + (index * 4));
  return value;
}
...
const int buf25_offset = 12288;
int32_t mlir_aie_read_buffer_buf25(aie_libxaie_ctx_t *ctx, int index) {
  int32_t value =
      XAieTile_DmReadWord(&(ctx->TileInst[11][3]), buf25_offset + (index * 4));
  return value;
}
...
int32_t mlir_aie_read_buffer_buf16(aie_libxaie_ctx_t *ctx, int index) {
  int32_t value =
      XAieTile_DmReadWord(&(ctx->TileInst[10][3]), buf16_offset + (index * 4));
  return value;
}
...
int32_t mlir_aie_read_buffer_buf17(aie_libxaie_ctx_t *ctx, int index) {
  int32_t value =
      XAieTile_DmReadWord(&(ctx->TileInst[10][3]), buf17_offset + (index * 4));
  return value;
}
...
const int buf18_offset = 12288;
int32_t mlir_aie_read_buffer_buf18(aie_libxaie_ctx_t *ctx, int index) {
  int32_t value =
      XAieTile_DmReadWord(&(ctx->TileInst[10][3]), buf18_offset + (index * 4));
  return value;
}
...
const int buf33_offset = 4096;
int32_t mlir_aie_read_buffer_buf33(aie_libxaie_ctx_t *ctx, int index) {
  int32_t value =
      XAieTile_DmReadWord(&(ctx->TileInst[13][2]), buf33_offset + (index * 4));
  return value;
}
...
const int buf34_offset = 8192;
int32_t mlir_aie_read_buffer_buf34(aie_libxaie_ctx_t *ctx, int index) {
  int32_t value =
      XAieTile_DmReadWord(&(ctx->TileInst[13][2]), buf34_offset + (index * 4));
  return value;
}
...
const int buf35_offset = 12288;
int32_t mlir_aie_read_buffer_buf35(aie_libxaie_ctx_t *ctx, int index) {
  int32_t value =
      XAieTile_DmReadWord(&(ctx->TileInst[13][2]), buf35_offset + (index * 4));
  return value;
}
...
const int buf36_offset = 16384;
int32_t mlir_aie_read_buffer_buf36(aie_libxaie_ctx_t *ctx, int index) {
  int32_t value =
      XAieTile_DmReadWord(&(ctx->TileInst[13][2]), buf36_offset + (index * 4));
  return value;
}
...
const int buf30_offset = 4096;
int32_t mlir_aie_read_buffer_buf30(aie_libxaie_ctx_t *ctx, int index) {
  int32_t value =
      XAieTile_DmReadWord(&(ctx->TileInst[12][3]), buf30_offset + (index * 4));
  return value;
}
...
const int buf31_offset = 8192;
int32_t mlir_aie_read_buffer_buf31(aie_libxaie_ctx_t *ctx, int index) {
  int32_t value =
      XAieTile_DmReadWord(&(ctx->TileInst[12][3]), buf31_offset + (index * 4));
  return value;
}
...
const int bui32_offset = 12288;
int32_t mlir_aie_read_buffer_bui32(aie_libxaie_ctx_t *ctx, int index) {
  int32_t value =
      XAieTile_DmReadWord(&(ctx->TileInst[12][3]), bui32_offset + (index * 4));
  return value;
}
...
int32_t mlir_aie_read_buffer_buf19(aie_libxaie_ctx_t *ctx, int index) {
  int32_t value =
      XAieTile_DmReadWord(&(ctx->TileInst[11][2]), buf19_offset + (index * 4));
  return value;
}
...
int32_t mlir_aie_read_buffer_buf20(aie_libxaie_ctx_t *ctx, int index) {
  int32_t value =
      XAieTile_DmReadWord(&(ctx->TileInst[11][2]), buf20_offset + (index * 4));
  return value;
}
...
int32_t mlir_aie_read_buffer_buf21(aie_libxaie_ctx_t *ctx, int index) {
  int32_t value =
      XAieTile_DmReadWord(&(ctx->TileInst[11][2]), buf21_offset + (index * 4));
  return value;
}
...
const int buf22_offset = 16384;
int32_t mlir_aie_read_buffer_buf22(aie_libxaie_ctx_t *ctx, int index) {
  int32_t value =
      XAieTile_DmReadWord(&(ctx->TileInst[11][2]), buf22_offset + (index * 4));
  return value;
}
...
int32_t mlir_aie_read_buffer_buf37(aie_libxaie_ctx_t *ctx, int index) {
  int32_t value =
      XAieTile_DmReadWord(&(ctx->TileInst[13][3]), buf37_offset + (index * 4));
  return value;
}
...
int32_t mlir_aie_read_buffer_buf38(aie_libxaie_ctx_t *ctx, int index) {
  int32_t value =
      XAieTile_DmReadWord(&(ctx->TileInst[13][3]), buf38_offset + (index * 4));
  return value;
}
...
int32_t mlir_aie_read_buffer_buf39(aie_libxaie_ctx_t *ctx, int index) {
  int32_t value =
      XAieTile_DmReadWord(&(ctx->TileInst[13][3]), buf39_offset + (index * 4));
  return value;
}
...
const int buf26_offset = 4096;
int32_t mlir_aie_read_buffer_buf26(aie_libxaie_ctx_t *ctx, int index) {
  int32_t value =
      XAieTile_DmReadWord(&(ctx->TileInst[12][2]), buf26_offset + (index * 4));
  return value;
}
...
const int buf27_offset = 8192;
int32_t mlir_aie_read_buffer_buf27(aie_libxaie_ctx_t *ctx, int index) {
  int32_t value =
      XAieTile_DmReadWord(&(ctx->TileInst[12][2]), buf27_offset + (index * 4));
  return value;
}
...
const int buf28_offset = 12288;
int32_t mlir_aie_read_buffer_buf28(aie_libxaie_ctx_t *ctx, int index) {
  int32_t value =
      XAieTile_DmReadWord(&(ctx->TileInst[12][2]), buf28_offset + (index * 4));
  return value;
}
...
const int buf29_offset = 16384;
int32_t mlir_aie_read_buffer_buf29(aie_libxaie_ctx_t *ctx, int index) {
  int32_t value =
      XAieTile_DmReadWord(&(ctx->TileInst[12][2]), buf29_offset + (index * 4));
  return value;
}
