module @gemm {
  ...
  %12 = AIE.shimDMA(%7) {
    %20 = AIE.dmaStart(S2MM0, ^bb3, ^bb1)
  ^bb1:  // pred: ^bb0
    %21 = AIE.dmaStart(MM2S0, ^bb3, ^bb2)
  ^bb2:  // pred: ^bb1
    %22 = AIE.dmaStart(MM2S1, ^bb3, ^bb3)
  ^bb3:  // 4 preds: ^bb0, ^bb1, ^bb2, ^bb2
    AIE.end
  }
  AIE.packet_flow(3) {
  }
  ...
  %19 = AIE.mem(%13) {
    %20 = AIE.dmaStart(S2MM0, ^bb3, ^bb1)
  ^bb1:  // pred: ^bb0
    %21 = AIE.dmaStart(S2MM1, ^bb3, ^bb2)
  ^bb2:  // pred: ^bb1
    %22 = AIE.dmaStart(MM2S0, ^bb3, ^bb3)
  ^bb3:  // 4 preds: ^bb0, ^bb1, ^bb2, ^bb2
    AIE.end
  }
  AIE.packet_flow(0) {
