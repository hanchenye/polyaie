module @gemm {
  ...
  AIE.broad_packet(%3, DMA : 1) {
    AIE.bp_id(4) {
      AIE.bp_dest<%38, DMA : 0>
    }
    AIE.bp_id(5) {
      AIE.bp_dest<%47, DMA : 1>
    }
    AIE.bp_id(6) {
  ...
  AIE.broad_packet(%3, DMA : 0) {
    AIE.bp_id(0) {
      AIE.bp_dest<%38, DMA : 1>
      AIE.bp_dest<%66, DMA : 1>
      AIE.bp_dest<%94, DMA : 1>
    }
    AIE.bp_id(1) {
      AIE.bp_dest<%47, DMA : 0>
      AIE.bp_dest<%75, DMA : 0>
      AIE.bp_dest<%103, DMA : 0>
    }
    AIE.bp_id(2) {
      AIE.bp_dest<%56, DMA : 1>
      AIE.bp_dest<%84, DMA : 0>
      AIE.bp_dest<%112, DMA : 1>
    }
  }
  %18 = AIE.tile(11, 0)
  %19 = AIE.lock(%18, 5)
  ...
  AIE.broad_packet(%18, DMA : 1) {
    AIE.bp_id(4) {
      AIE.bp_dest<%94, DMA : 0>
    }
    AIE.bp_id(5) {
      AIE.bp_dest<%103, DMA : 1>
    }
    AIE.bp_id(6) {
      AIE.bp_dest<%112, DMA : 0>
    }
  }
  AIE.broad_packet(%18, DMA : 0) {
    AIE.bp_id(4) {
      AIE.bp_dest<%66, DMA : 0>
    }
    AIE.bp_id(5) {
      AIE.bp_dest<%75, DMA : 1>
    }
    AIE.bp_id(6) {
