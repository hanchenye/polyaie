module @gemm attributes {llvm.data_layout = "", llvm.target_triple = "aie"} {
  ...
  llvm.func @core122() {
    ...
    %27 = llvm.mlir.addressof @buf39 : !llvm.ptr<array<32 x array<32 x i32>>>
    ...
    %32 = llvm.mlir.addressof @buf40 : !llvm.ptr<array<32 x array<32 x i32>>>
    ...
    %37 = llvm.mlir.addressof @buf41 : !llvm.ptr<array<32 x array<32 x i32>>>
