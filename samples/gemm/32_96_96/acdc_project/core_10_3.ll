...
define void @core103() !dbg !3 {
  ...
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([32 x [32 x i32]]* @buf22 to i64), i64 31), i64 0)), !dbg !12
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([32 x [32 x i32]]* @buf23 to i64), i64 31), i64 0)), !dbg !13
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([32 x [32 x i32]]* @buf24 to i64), i64 31), i64 0)), !dbg !14
  ...
  call void @llvm.aie.lock.acquire.reg(i32 48, i32 1), !dbg !18
  call void @llvm.aie.lock.acquire.reg(i32 35, i32 0), !dbg !19
  ...
  call void @llvm.aie.lock.release.reg(i32 35, i32 1), !dbg !25
...
!4 = !DIFile(filename: "acdc_project/core_10_3.opt.mlir", directory: "/proj/rdi/staff/jinmingz/nobkup/polyaie/samples/gemm/32_96_96")
