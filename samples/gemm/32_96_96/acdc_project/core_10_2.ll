...
define void @core102() !dbg !3 {
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([32 x [32 x i32]]* @buf25 to i64), i64 31), i64 0)), !dbg !7
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([32 x [32 x i32]]* @buf26 to i64), i64 31), i64 0)), !dbg !9
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([32 x [32 x i32]]* @buf27 to i64), i64 31), i64 0)), !dbg !10
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([32 x [32 x i32]]* @buf28 to i64), i64 31), i64 0)), !dbg !11
  ...
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([32 x [32 x i32]]* @buf19 to i64), i64 31), i64 0)), !dbg !16
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([32 x [32 x i32]]* @buf20 to i64), i64 31), i64 0)), !dbg !17
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([32 x [32 x i32]]* @buf21 to i64), i64 31), i64 0)), !dbg !18
  call void @llvm.aie.lock.acquire.reg(i32 16, i32 1), !dbg !19
  call void @llvm.aie.lock.acquire.reg(i32 17, i32 1), !dbg !20
  call void @llvm.aie.lock.acquire.reg(i32 34, i32 0), !dbg !21
  ...
  call void @llvm.aie.lock.release.reg(i32 34, i32 1), !dbg !23
...
!4 = !DIFile(filename: "acdc_project/core_10_2.opt.mlir", directory: "/proj/rdi/staff/jinmingz/nobkup/polyaie/samples/gemm/32_96_96")
