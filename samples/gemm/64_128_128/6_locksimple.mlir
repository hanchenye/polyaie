module @gemm {
  ...
  AIE.broad_packet(%3, DMA : 0) {
    AIE.bp_id(0) {
      AIE.bp_dest<%70, DMA : 1>
      AIE.bp_dest<%107, DMA : 1>
      AIE.bp_dest<%144, DMA : 1>
      AIE.bp_dest<%181, DMA : 1>
    }
    AIE.bp_id(1) {
      AIE.bp_dest<%79, DMA : 1>
      AIE.bp_dest<%116, DMA : 0>
      AIE.bp_dest<%153, DMA : 1>
      AIE.bp_dest<%190, DMA : 0>
    }
    AIE.bp_id(2) {
      AIE.bp_dest<%88, DMA : 0>
      AIE.bp_dest<%125, DMA : 0>
  ...
  AIE.broad_packet(%3, DMA : 1) {
    AIE.bp_id(4) {
      AIE.bp_dest<%70, DMA : 0>
      AIE.bp_dest<%218, DMA : 0>
    }
    AIE.bp_id(5) {
  ...
  AIE.broad_packet(%22, DMA : 0) {
    AIE.bp_id(4) {
      ...
      AIE.bp_dest<%329, DMA : 0>
    }
    AIE.bp_id(5) {
      AIE.bp_dest<%190, DMA : 1>
      AIE.bp_dest<%338, DMA : 1>
    }
    AIE.bp_id(6) {
  ...
  AIE.broad_packet(%41, DMA : 0) {
    AIE.bp_id(4) {
      AIE.bp_dest<%107, DMA : 0>
      AIE.bp_dest<%255, DMA : 0>
    }
    AIE.bp_id(5) {
      AIE.bp_dest<%116, DMA : 1>
      AIE.bp_dest<%264, DMA : 1>
    }
    AIE.bp_id(6) {
      AIE.bp_dest<%125, DMA : 1>
