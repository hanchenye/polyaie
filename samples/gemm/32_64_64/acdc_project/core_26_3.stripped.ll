...
define void @core263() local_unnamed_addr {
  ...
  tail call void @llvm.aie.lock.acquire.reg(i32 50, i32 0)
  tail call void @extern_kernel(i32* getelementptr inbounds ([32 x [32 x i32]], [32 x [32 x i32]]* @buf8, i64 0, i64 0, i64 0), i32* getelementptr inbounds ([32 x [32 x i32]], [32 x [32 x i32]]* @buf12, i64 0, i64 0, i64 0), i32* getelementptr inbounds ([32 x [32 x i32]], [32 x [32 x i32]]* @buf13, i64 0, i64 0, i64 0), i32* getelementptr inbounds ([32 x [32 x i32]], [32 x [32 x i32]]* @buf14, i64 0, i64 0, i64 0))
  tail call void @llvm.aie.lock.release.reg(i32 50, i32 1)
