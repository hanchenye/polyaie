module @gemm attributes {llvm.data_layout = "", llvm.target_triple = "aie"} {
  ...
  llvm.func @core263() {
    ...
    %7 = llvm.mlir.addressof @buf12 : !llvm.ptr<array<32 x array<32 x i32>>>
    ...
    %14 = llvm.mlir.addressof @buf13 : !llvm.ptr<array<32 x array<32 x i32>>>
    ...
    %19 = llvm.mlir.addressof @buf14 : !llvm.ptr<array<32 x array<32 x i32>>>
