module @gemm attributes {llvm.target_triple = "aie"} {
  ...
  func @core273() {
    ...
    %4 = memref.get_global @buf12 : memref<32x32xi32>
    memref.assume_alignment %4, 32 : memref<32x32xi32>
    %5 = memref.get_global @buf13 : memref<32x32xi32>
    memref.assume_alignment %5, 32 : memref<32x32xi32>
    %6 = memref.get_global @buf14 : memref<32x32xi32>
    ...
    %11 = arith.index_cast %c51 : index to i32
    ...
    %16 = arith.index_cast %c51 : index to i32
