module {
  dataflow.func @gemm(%arg0: memref<32x64xf32>, %arg1: memref<32x64xf32>, %arg2: memref<64x64xf32>, ...) attributes {argNames = ["in0", "in1", "in2"], polyaie.top_func, resNames = []} {
    %0 = "dataflow.tensor_load"(%arg2) {offsets = [32, 32], polyaie.PackID = 5 : i64, polyaie.channel = 0 : i64, polyaie.col = 27 : i64, polyaie.reuse = 2 : i64, polyaie.row = 0 : i64, sizes = [32, 32], strides = [1, 1]} : (memref<64x64xf32>) -> tensor<32x32xf32>
    %1 = "dataflow.tensor_load"(%arg2) {offsets = [0, 32], polyaie.PackID = 4 : i64, polyaie.channel = 0 : i64, polyaie.col = 27 : i64, polyaie.reuse = 2 : i64, polyaie.row = 0 : i64, sizes = [32, 32], strides = [1, 1]} : (memref<64x64xf32>) -> tensor<32x32xf32>
    %2 = "dataflow.tensor_load"(%arg0) {offsets = [0, 32], polyaie.channel = 2 : i64, polyaie.col = 0 : i64, polyaie.row = 0 : i64, sizes = [32, 32], strides = [1, 1]} : (memref<32x64xf32>) -> tensor<32x32xf32>
    %3 = "dataflow.tensor_load"(%arg1) {offsets = [0, 32], polyaie.PackID = 1 : i64, polyaie.channel = 0 : i64, polyaie.col = 26 : i64, polyaie.reuse = 2 : i64, polyaie.row = 0 : i64, sizes = [32, 32], strides = [1, 1]} : (memref<32x64xf32>) -> tensor<32x32xf32>
    %4 = "dataflow.tensor_load"(%arg2) {offsets = [32, 0], polyaie.PackID = 5 : i64, polyaie.channel = 1 : i64, polyaie.col = 26 : i64, polyaie.reuse = 2 : i64, polyaie.row = 0 : i64, sizes = [32, 32], strides = [1, 1]} : (memref<64x64xf32>) -> tensor<32x32xf32>
    %5 = "dataflow.tensor_load"(%arg1) {offsets = [0, 0], polyaie.PackID = 0 : i64, polyaie.channel = 0 : i64, polyaie.col = 26 : i64, polyaie.reuse = 2 : i64, polyaie.row = 0 : i64, sizes = [32, 32], strides = [1, 1]} : (memref<32x64xf32>) -> tensor<32x32xf32>
    %6 = "dataflow.tensor_load"(%arg2) {offsets = [0, 0], polyaie.PackID = 4 : i64, polyaie.channel = 1 : i64, polyaie.col = 26 : i64, polyaie.reuse = 2 : i64, polyaie.row = 0 : i64, sizes = [32, 32], strides = [1, 1]} : (memref<64x64xf32>) -> tensor<32x32xf32>
    %7 = "dataflow.tensor_load"(%arg0) {offsets = [0, 0], polyaie.channel = 2 : i64, polyaie.col = 0 : i64, polyaie.row = 0 : i64, sizes = [32, 32], strides = [1, 1]} : (memref<32x64xf32>) -> tensor<32x32xf32>
    ...
    "dataflow.tensor_store"(%arg0, %9) {offsets = [0, 0], polyaie.PackID = 0 : i64, polyaie.channel = 0 : i64, polyaie.col = 26 : i64, polyaie.row = 0 : i64, sizes = [32, 32], strides = [1, 1]} : (memref<32x64xf32>, tensor<32x32xf32>) -> ()
    ...
    "dataflow.tensor_store"(%arg0, %11) {offsets = [0, 32], polyaie.PackID = 1 : i64, polyaie.channel = 0 : i64, polyaie.col = 26 : i64, polyaie.row = 0 : i64, sizes = [32, 32], strides = [1, 1]} : (memref<32x64xf32>, tensor<32x32xf32>) -> ()
    "dataflow.return"() : () -> ()
  }
}
