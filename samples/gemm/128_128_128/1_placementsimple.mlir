module {
  dataflow.func @gemm(%arg0: memref<128x128xf32>, %arg1: memref<128x128xf32>, %arg2: memref<128x128xf32>, ...) attributes {argNames = ["in0", "in1", "in2"], polyaie.top_func, resNames = []} {
    ...
    %3 = "dataflow.tensor_load"(%arg1) {offsets = [96, 96], polyaie.PackID = 3 : i64, polyaie.channel = 1 : i64, polyaie.col = 19 : i64, polyaie.reuse = 4 : i64, polyaie.row = 0 : i64, sizes = [32, 32], strides = [1, 1]} : (memref<128x128xf32>) -> tensor<32x32xf32>
    %4 = "dataflow.tensor_load"(%arg1) {offsets = [96, 64], polyaie.PackID = 2 : i64, polyaie.channel = 1 : i64, polyaie.col = 19 : i64, polyaie.reuse = 4 : i64, polyaie.row = 0 : i64, sizes = [32, 32], strides = [1, 1]} : (memref<128x128xf32>) -> tensor<32x32xf32>
    %5 = "dataflow.tensor_load"(%arg1) {offsets = [96, 32], polyaie.PackID = 1 : i64, polyaie.channel = 1 : i64, polyaie.col = 19 : i64, polyaie.reuse = 4 : i64, polyaie.row = 0 : i64, sizes = [32, 32], strides = [1, 1]} : (memref<128x128xf32>) -> tensor<32x32xf32>
    %6 = "dataflow.tensor_load"(%arg1) {offsets = [96, 0], polyaie.PackID = 0 : i64, polyaie.channel = 1 : i64, polyaie.col = 19 : i64, polyaie.reuse = 4 : i64, polyaie.row = 0 : i64, sizes = [32, 32], strides = [1, 1]} : (memref<128x128xf32>) -> tensor<32x32xf32>
    ...
    %24 = "dataflow.tensor_load"(%arg2) {offsets = [96, 96], polyaie.PackID = 7 : i64, polyaie.channel = 0 : i64, polyaie.col = 18 : i64, polyaie.reuse = 4 : i64, polyaie.row = 0 : i64, sizes = [32, 32], strides = [1, 1]} : (memref<128x128xf32>) -> tensor<32x32xf32>
    %25 = "dataflow.tensor_load"(%arg2) {offsets = [64, 96], polyaie.PackID = 6 : i64, polyaie.channel = 0 : i64, polyaie.col = 18 : i64, polyaie.reuse = 4 : i64, polyaie.row = 0 : i64, sizes = [32, 32], strides = [1, 1]} : (memref<128x128xf32>) -> tensor<32x32xf32>
    %26 = "dataflow.tensor_load"(%arg2) {offsets = [32, 96], polyaie.PackID = 5 : i64, polyaie.channel = 0 : i64, polyaie.col = 18 : i64, polyaie.reuse = 4 : i64, polyaie.row = 0 : i64, sizes = [32, 32], strides = [1, 1]} : (memref<128x128xf32>) -> tensor<32x32xf32>
    %27 = "dataflow.tensor_load"(%arg2) {offsets = [0, 96], polyaie.PackID = 4 : i64, polyaie.channel = 0 : i64, polyaie.col = 18 : i64, polyaie.reuse = 4 : i64, polyaie.row = 0 : i64, sizes = [32, 32], strides = [1, 1]} : (memref<128x128xf32>) -> tensor<32x32xf32>
    ...
    %29 = "dataflow.tensor_load"(%arg2) {offsets = [96, 64], polyaie.PackID = 7 : i64, polyaie.channel = 1 : i64, polyaie.col = 11 : i64, polyaie.reuse = 4 : i64, polyaie.row = 0 : i64, sizes = [32, 32], strides = [1, 1]} : (memref<128x128xf32>) -> tensor<32x32xf32>
    %30 = "dataflow.tensor_load"(%arg2) {offsets = [64, 64], polyaie.PackID = 6 : i64, polyaie.channel = 1 : i64, polyaie.col = 11 : i64, polyaie.reuse = 4 : i64, polyaie.row = 0 : i64, sizes = [32, 32], strides = [1, 1]} : (memref<128x128xf32>) -> tensor<32x32xf32>
    %31 = "dataflow.tensor_load"(%arg2) {offsets = [32, 64], polyaie.PackID = 5 : i64, polyaie.channel = 1 : i64, polyaie.col = 11 : i64, polyaie.reuse = 4 : i64, polyaie.row = 0 : i64, sizes = [32, 32], strides = [1, 1]} : (memref<128x128xf32>) -> tensor<32x32xf32>
    %32 = "dataflow.tensor_load"(%arg2) {offsets = [0, 64], polyaie.PackID = 4 : i64, polyaie.channel = 1 : i64, polyaie.col = 11 : i64, polyaie.reuse = 4 : i64, polyaie.row = 0 : i64, sizes = [32, 32], strides = [1, 1]} : (memref<128x128xf32>) -> tensor<32x32xf32>
    ...
    %34 = "dataflow.tensor_load"(%arg2) {offsets = [96, 32], polyaie.PackID = 7 : i64, polyaie.channel = 0 : i64, polyaie.col = 11 : i64, polyaie.reuse = 4 : i64, polyaie.row = 0 : i64, sizes = [32, 32], strides = [1, 1]} : (memref<128x128xf32>) -> tensor<32x32xf32>
    %35 = "dataflow.tensor_load"(%arg2) {offsets = [64, 32], polyaie.PackID = 6 : i64, polyaie.channel = 0 : i64, polyaie.col = 11 : i64, polyaie.reuse = 4 : i64, polyaie.row = 0 : i64, sizes = [32, 32], strides = [1, 1]} : (memref<128x128xf32>) -> tensor<32x32xf32>
    %36 = "dataflow.tensor_load"(%arg2) {offsets = [32, 32], polyaie.PackID = 5 : i64, polyaie.channel = 0 : i64, polyaie.col = 11 : i64, polyaie.reuse = 4 : i64, polyaie.row = 0 : i64, sizes = [32, 32], strides = [1, 1]} : (memref<128x128xf32>) -> tensor<32x32xf32>
    %37 = "dataflow.tensor_load"(%arg2) {offsets = [0, 32], polyaie.PackID = 4 : i64, polyaie.channel = 0 : i64, polyaie.col = 11 : i64, polyaie.reuse = 4 : i64, polyaie.row = 0 : i64, sizes = [32, 32], strides = [1, 1]} : (memref<128x128xf32>) -> tensor<32x32xf32>
    ...
    %40 = "dataflow.tensor_load"(%arg2) {offsets = [96, 0], polyaie.PackID = 7 : i64, polyaie.channel = 1 : i64, polyaie.col = 10 : i64, polyaie.reuse = 4 : i64, polyaie.row = 0 : i64, sizes = [32, 32], strides = [1, 1]} : (memref<128x128xf32>) -> tensor<32x32xf32>
    ...
    %42 = "dataflow.tensor_load"(%arg2) {offsets = [64, 0], polyaie.PackID = 6 : i64, polyaie.channel = 1 : i64, polyaie.col = 10 : i64, polyaie.reuse = 4 : i64, polyaie.row = 0 : i64, sizes = [32, 32], strides = [1, 1]} : (memref<128x128xf32>) -> tensor<32x32xf32>
    ...
    %44 = "dataflow.tensor_load"(%arg2) {offsets = [32, 0], polyaie.PackID = 5 : i64, polyaie.channel = 1 : i64, polyaie.col = 10 : i64, polyaie.reuse = 4 : i64, polyaie.row = 0 : i64, sizes = [32, 32], strides = [1, 1]} : (memref<128x128xf32>) -> tensor<32x32xf32>
    ...
    %46 = "dataflow.tensor_load"(%arg2) {offsets = [0, 0], polyaie.PackID = 4 : i64, polyaie.channel = 1 : i64, polyaie.col = 10 : i64, polyaie.reuse = 4 : i64, polyaie.row = 0 : i64, sizes = [32, 32], strides = [1, 1]} : (memref<128x128xf32>) -> tensor<32x32xf32>
