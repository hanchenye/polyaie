module @gemm {
  ...
  AIE.broad_packet(%3, DMA : 1) {
    AIE.bp_id(0) {
      AIE.bp_dest<%541, DMA : 1>
      AIE.bp_dest<%578, DMA : 1>
      AIE.bp_dest<%615, DMA : 0>
      AIE.bp_dest<%652, DMA : 1>
    }
    AIE.bp_id(1) {
      AIE.bp_dest<%550, DMA : 0>
      AIE.bp_dest<%587, DMA : 1>
      AIE.bp_dest<%624, DMA : 0>
      AIE.bp_dest<%661, DMA : 0>
    }
    AIE.bp_id(2) {
      AIE.bp_dest<%559, DMA : 1>
      AIE.bp_dest<%596, DMA : 1>
      AIE.bp_dest<%633, DMA : 1>
      AIE.bp_dest<%670, DMA : 1>
    }
    AIE.bp_id(3) {
      AIE.bp_dest<%568, DMA : 0>
      AIE.bp_dest<%605, DMA : 0>
      AIE.bp_dest<%642, DMA : 0>
      AIE.bp_dest<%679, DMA : 0>
    }
  }
  AIE.broad_packet(%3, DMA : 0) {
    AIE.bp_id(0) {
      AIE.bp_dest<%393, DMA : 1>
      AIE.bp_dest<%430, DMA : 1>
      AIE.bp_dest<%467, DMA : 1>
      AIE.bp_dest<%504, DMA : 1>
    }
    AIE.bp_id(1) {
      AIE.bp_dest<%402, DMA : 1>
      AIE.bp_dest<%439, DMA : 1>
      AIE.bp_dest<%476, DMA : 1>
      AIE.bp_dest<%513, DMA : 1>
    }
    AIE.bp_id(2) {
      AIE.bp_dest<%411, DMA : 1>
      AIE.bp_dest<%448, DMA : 0>
      AIE.bp_dest<%485, DMA : 1>
      AIE.bp_dest<%522, DMA : 0>
    }
    AIE.bp_id(3) {
      AIE.bp_dest<%420, DMA : 0>
      AIE.bp_dest<%457, DMA : 0>
      AIE.bp_dest<%494, DMA : 0>
      AIE.bp_dest<%531, DMA : 0>
    }
  }
  %30 = AIE.tile(10, 0)
  %31 = AIE.lock(%30, 7)
  ...
  AIE.broad_packet(%30, DMA : 0) {
    ...
    AIE.bp_id(2) {
      ...
      AIE.bp_dest<%226, DMA : 0>
    }
    AIE.bp_id(3) {
      AIE.bp_dest<%124, DMA : 0>
      AIE.bp_dest<%161, DMA : 0>
      AIE.bp_dest<%198, DMA : 1>
      AIE.bp_dest<%235, DMA : 0>
    }
  }
  AIE.broad_packet(%30, DMA : 1) {
    AIE.bp_id(4) {
      AIE.bp_dest<%97, DMA : 0>
      AIE.bp_dest<%245, DMA : 0>
      AIE.bp_dest<%393, DMA : 0>
      AIE.bp_dest<%541, DMA : 0>
    }
    AIE.bp_id(5) {
      AIE.bp_dest<%106, DMA : 0>
      AIE.bp_dest<%254, DMA : 1>
      AIE.bp_dest<%402, DMA : 0>
      AIE.bp_dest<%550, DMA : 1>
    }
    AIE.bp_id(6) {
      AIE.bp_dest<%115, DMA : 0>
      AIE.bp_dest<%263, DMA : 1>
      AIE.bp_dest<%411, DMA : 0>
      AIE.bp_dest<%559, DMA : 0>
    }
    AIE.bp_id(7) {
      AIE.bp_dest<%124, DMA : 1>
      AIE.bp_dest<%272, DMA : 1>
      AIE.bp_dest<%420, DMA : 1>
      AIE.bp_dest<%568, DMA : 1>
    }
  }
  %49 = AIE.tile(18, 0)
  %50 = AIE.lock(%49, 7)
  ...
  AIE.broad_packet(%49, DMA : 0) {
    AIE.bp_id(4) {
      AIE.bp_dest<%208, DMA : 0>
      AIE.bp_dest<%356, DMA : 0>
      AIE.bp_dest<%504, DMA : 0>
      AIE.bp_dest<%652, DMA : 0>
    }
    AIE.bp_id(5) {
      AIE.bp_dest<%217, DMA : 0>
      AIE.bp_dest<%365, DMA : 1>
      AIE.bp_dest<%513, DMA : 0>
      AIE.bp_dest<%661, DMA : 1>
    }
    AIE.bp_id(6) {
      AIE.bp_dest<%226, DMA : 1>
      AIE.bp_dest<%374, DMA : 1>
      AIE.bp_dest<%522, DMA : 1>
      AIE.bp_dest<%670, DMA : 0>
    }
    AIE.bp_id(7) {
      AIE.bp_dest<%235, DMA : 1>
      AIE.bp_dest<%383, DMA : 1>
      AIE.bp_dest<%531, DMA : 1>
      AIE.bp_dest<%679, DMA : 1>
    }
  }
  AIE.broad_packet(%49, DMA : 1) {
    AIE.bp_id(0) {
      AIE.bp_dest<%245, DMA : 1>
      AIE.bp_dest<%282, DMA : 1>
      AIE.bp_dest<%319, DMA : 0>
      AIE.bp_dest<%356, DMA : 1>
    }
    AIE.bp_id(1) {
      AIE.bp_dest<%254, DMA : 0>
      AIE.bp_dest<%291, DMA : 0>
      AIE.bp_dest<%328, DMA : 0>
      AIE.bp_dest<%365, DMA : 0>
    }
    AIE.bp_id(2) {
      AIE.bp_dest<%263, DMA : 0>
      AIE.bp_dest<%300, DMA : 0>
      AIE.bp_dest<%337, DMA : 0>
      AIE.bp_dest<%374, DMA : 0>
    }
    AIE.bp_id(3) {
      AIE.bp_dest<%272, DMA : 0>
      AIE.bp_dest<%309, DMA : 0>
      AIE.bp_dest<%346, DMA : 0>
      AIE.bp_dest<%383, DMA : 0>
    }
  }
  %76 = AIE.tile(11, 0)
  %77 = AIE.lock(%76, 7)
  ...
  AIE.broad_packet(%76, DMA : 0) {
    AIE.bp_id(4) {
      AIE.bp_dest<%134, DMA : 0>
      AIE.bp_dest<%282, DMA : 0>
      AIE.bp_dest<%430, DMA : 0>
      AIE.bp_dest<%578, DMA : 0>
    }
    AIE.bp_id(5) {
      AIE.bp_dest<%143, DMA : 0>
      AIE.bp_dest<%291, DMA : 1>
      AIE.bp_dest<%439, DMA : 0>
      AIE.bp_dest<%587, DMA : 0>
    }
    AIE.bp_id(6) {
      AIE.bp_dest<%152, DMA : 1>
      AIE.bp_dest<%300, DMA : 1>
      AIE.bp_dest<%448, DMA : 1>
      AIE.bp_dest<%596, DMA : 0>
    }
    AIE.bp_id(7) {
      AIE.bp_dest<%161, DMA : 1>
      AIE.bp_dest<%309, DMA : 1>
      AIE.bp_dest<%457, DMA : 1>
      AIE.bp_dest<%605, DMA : 1>
    }
  }
  AIE.broad_packet(%76, DMA : 1) {
    AIE.bp_id(4) {
      AIE.bp_dest<%171, DMA : 0>
      AIE.bp_dest<%319, DMA : 1>
      AIE.bp_dest<%467, DMA : 0>
      AIE.bp_dest<%615, DMA : 1>
    }
    AIE.bp_id(5) {
      AIE.bp_dest<%180, DMA : 0>
      AIE.bp_dest<%328, DMA : 1>
      AIE.bp_dest<%476, DMA : 0>
      AIE.bp_dest<%624, DMA : 1>
    }
    AIE.bp_id(6) {
      AIE.bp_dest<%189, DMA : 0>
      AIE.bp_dest<%337, DMA : 1>
      AIE.bp_dest<%485, DMA : 0>
      AIE.bp_dest<%633, DMA : 0>
    }
    AIE.bp_id(7) {
      AIE.bp_dest<%198, DMA : 0>
      AIE.bp_dest<%346, DMA : 1>
      AIE.bp_dest<%494, DMA : 1>
      AIE.bp_dest<%642, DMA : 1>
    }
  }
  %97 = AIE.tile(10, 2)
  %98 = AIE.lock(%97, 1)
