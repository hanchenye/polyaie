module @gemm {
  ...
  %2 = AIE.switchbox(%0) {
    ...
    %378 = AIE.amsel<0> (2)
    %379 = AIE.amsel<0> (3)
    %380 = AIE.masterset(South : 2, %379)
    %381 = AIE.masterset(South : 3, %378)
    %382 = AIE.masterset(North : 0, %377)
    %383 = AIE.masterset(North : 1, %376)
    %384 = AIE.masterset(East : 0, %377)
    %385 = AIE.masterset(East : 1, %376)
  ...
  %23 = AIE.shimDMA(%0) {
    %376 = AIE.dmaStart(S2MM0, ^bb1, ^bb5)
  ^bb1:  // 2 preds: ^bb0, ^bb4
  ...
  ^bb4:  // pred: ^bb3
    ...
    br ^bb1
  ^bb5:  // pred: ^bb0
    %377 = AIE.dmaStart(S2MM1, ^bb6, ^bb10)
  ^bb6:  // 2 preds: ^bb5, ^bb9
  ...
  ^bb9:  // pred: ^bb8
    ...
    br ^bb6
  ^bb10:  // pred: ^bb5
    %378 = AIE.dmaStart(MM2S0, ^bb11, ^bb14)
  ...
  ^bb13:  // pred: ^bb12
    ...
    br ^bb11
  ^bb14:  // pred: ^bb10
    %379 = AIE.dmaStart(MM2S1, ^bb15, ^bb18)
  ...
  %26 = AIE.switchbox(%24) {
    ...
    %377 = AIE.amsel<0> (1)
    %378 = AIE.amsel<0> (2)
    %379 = AIE.masterset(West : 0, %376)
    %380 = AIE.masterset(West : 1, %377)
    %381 = AIE.masterset(North : 0, %377)
    %382 = AIE.masterset(North : 1, %378)
  ...
  %39 = AIE.shimDMA(%24) {
    %376 = AIE.dmaStart(MM2S0, ^bb1, ^bb4)
  ^bb1:  // 2 preds: ^bb0, ^bb3
  ...
  ^bb3:  // pred: ^bb2
    ...
    br ^bb1
  ^bb4:  // pred: ^bb0
    %377 = AIE.dmaStart(MM2S1, ^bb5, ^bb8)
  ^bb5:  // 2 preds: ^bb4, ^bb7
  ...
  %42 = AIE.switchbox(%40) {
    ...
    %379 = AIE.amsel<0> (2)
    %380 = AIE.amsel<0> (3)
    %381 = AIE.masterset(South : 2, %380)
    %382 = AIE.masterset(North : 0, %378)
    %383 = AIE.masterset(North : 1, %379)
    %384 = AIE.masterset(East : 0, %378)
    %385 = AIE.masterset(East : 1, %376)
    %386 = AIE.masterset(East : 2, %379)
    %387 = AIE.masterset(East : 3, %377)
    AIE.packetrules(North : 0) {
      AIE.rule(31, 0, %380)
    }
    AIE.packetrules(South : 7) {
  ...
  %56 = AIE.shimDMA(%40) {
    %376 = AIE.dmaStart(S2MM0, ^bb1, ^bb2)
  ^bb1:  // 2 preds: ^bb0, ^bb1
    AIE.dmaBd(<%55 : memref<1025xi32>, 0, 1025>, 0)
    br ^bb1
  ^bb2:  // pred: ^bb0
    %377 = AIE.dmaStart(MM2S0, ^bb3, ^bb6)
  ^bb3:  // 2 preds: ^bb2, ^bb5
  ...
  ^bb5:  // pred: ^bb4
    ...
    br ^bb3
  ^bb6:  // pred: ^bb2
    %378 = AIE.dmaStart(MM2S1, ^bb7, ^bb10)
  ^bb7:  // 2 preds: ^bb6, ^bb9
  ...
  %59 = AIE.switchbox(%58) {
    ...
    %380 = AIE.amsel<0> (2)
    %381 = AIE.amsel<0> (3)
    %382 = AIE.masterset(DMA : 0, %378)
    %383 = AIE.masterset(DMA : 1, %379)
    %384 = AIE.masterset(South : 0, %380)
    %385 = AIE.masterset(South : 1, %381)
    %386 = AIE.masterset(North : 0, %377)
    %387 = AIE.masterset(North : 1, %376)
    AIE.packetrules(North : 1) {
      AIE.rule(31, 3, %381)
      AIE.rule(31, 2, %381)
      AIE.rule(31, 1, %381)
  ...
  %60 = AIE.lock(%58, 1)
  %61 = AIE.lock(%58, 0)
  %62 = AIE.buffer(%58) {sym_name = "buf27"} : memref<32x32xi32>
  %63 = AIE.buffer(%58) {sym_name = "buf28"} : memref<32x32xi32>
  %64 = AIE.buffer(%58) {sym_name = "buf29"} : memref<32x32xi32>
  %65 = AIE.buffer(%58) {sym_name = "buf30"} : memref<32x32xi32>
  %66 = AIE.core(%58) {
  ...
  ^bb1:  // 2 preds: ^bb0, ^bb1
    ...
    br ^bb1
  ^bb2:  // pred: ^bb0
    %377 = AIE.dmaStart(S2MM1, ^bb3, ^bb4)
  ^bb3:  // 2 preds: ^bb2, ^bb3
  ...
  %69 = AIE.switchbox(%68) {
    ...
    %383 = AIE.masterset(DMA : 1, %379)
    %384 = AIE.masterset(South : 0, %380)
    %385 = AIE.masterset(South : 1, %376)
    %386 = AIE.masterset(North : 0, %381)
    %387 = AIE.masterset(North : 1, %377)
    AIE.packetrules(North : 1) {
      AIE.rule(31, 3, %376)
      AIE.rule(31, 2, %376)
      AIE.rule(31, 1, %376)
  ...
  %71 = AIE.lock(%68, 1)
  %72 = AIE.lock(%68, 0)
  %73 = AIE.buffer(%68) {sym_name = "buf31"} : memref<32x32xi32>
  %74 = AIE.buffer(%68) {sym_name = "bui32"} : memref<32x32xi32>
  %75 = AIE.buffer(%68) {sym_name = "buf33"} : memref<32x32xi32>
  %76 = AIE.core(%68) {
  ...
  %80 = AIE.switchbox(%78) {
    ...
    %378 = AIE.amsel<0> (2)
    %379 = AIE.amsel<0> (3)
    %380 = AIE.masterset(DMA : 0, %378)
    %381 = AIE.masterset(DMA : 1, %377)
    %382 = AIE.masterset(South : 0, %379)
    %383 = AIE.masterset(South : 1, %376)
  ...
  %83 = AIE.lock(%78, 1)
  %84 = AIE.lock(%78, 0)
  %85 = AIE.buffer(%78) {sym_name = "buf34"} : memref<32x32xi32>
  %86 = AIE.buffer(%78) {sym_name = "buf35"} : memref<32x32xi32>
  %87 = AIE.buffer(%78) {sym_name = "buf36"} : memref<32x32xi32>
  %88 = AIE.core(%78) {
  ...
  ^bb3:  // 2 preds: ^bb2, ^bb3
    ...
    br ^bb3
  ^bb4:  // pred: ^bb2
    %378 = AIE.dmaStart(MM2S0, ^bb5, ^bb6)
  ^bb5:  // 2 preds: ^bb4, ^bb5
  ...
  %91 = AIE.switchbox(%90) {
    ...
    %379 = AIE.amsel<0> (2)
    %380 = AIE.amsel<0> (3)
    %381 = AIE.masterset(DMA : 0, %379)
    %382 = AIE.masterset(DMA : 1, %376)
    %383 = AIE.masterset(South : 0, %380)
    %384 = AIE.masterset(North : 0, %377)
    %385 = AIE.masterset(North : 1, %378)
    AIE.packetrules(North : 0) {
      AIE.rule(31, 0, %380)
    }
    AIE.packetrules(South : 1) {
  ...
  %92 = AIE.lock(%90, 1)
  %93 = AIE.lock(%90, 0)
  %94 = AIE.buffer(%90) {sym_name = "buf37"} : memref<32x32xi32>
  %95 = AIE.buffer(%90) {sym_name = "buf38"} : memref<32x32xi32>
  %96 = AIE.buffer(%90) {sym_name = "buf39"} : memref<32x32xi32>
  %97 = AIE.buffer(%90) {sym_name = "buf40"} : memref<32x32xi32>
  %98 = AIE.core(%90) {
  ...
  %101 = AIE.switchbox(%100) {
    ...
    %379 = AIE.amsel<0> (2)
    %380 = AIE.amsel<0> (3)
    %381 = AIE.masterset(DMA : 0, %378)
    %382 = AIE.masterset(DMA : 1, %377)
    %383 = AIE.masterset(South : 0, %376)
    %384 = AIE.masterset(North : 0, %380)
    %385 = AIE.masterset(North : 1, %379)
    AIE.packetrules(North : 0) {
      AIE.rule(31, 0, %376)
    }
    AIE.packetrules(South : 1) {
  ...
  %103 = AIE.lock(%100, 1)
  %104 = AIE.lock(%100, 0)
  %105 = AIE.buffer(%100) {sym_name = "buf41"} : memref<32x32xi32>
  %106 = AIE.buffer(%100) {sym_name = "buf42"} : memref<32x32xi32>
  %107 = AIE.buffer(%100) {sym_name = "buf43"} : memref<32x32xi32>
  %108 = AIE.core(%100) {
  ...
  %112 = AIE.switchbox(%110) {
    ...
    %379 = AIE.amsel<0> (2)
    %380 = AIE.amsel<0> (3)
    %381 = AIE.masterset(DMA : 0, %376)
    %382 = AIE.masterset(DMA : 1, %377)
    %383 = AIE.masterset(South : 0, %379)
    %384 = AIE.masterset(West : 0, %380)
    %385 = AIE.masterset(West : 1, %378)
  ...
  %115 = AIE.lock(%110, 1)
  %116 = AIE.lock(%110, 0)
  %117 = AIE.buffer(%110) {sym_name = "buf44"} : memref<32x32xi32>
  %118 = AIE.buffer(%110) {sym_name = "buf45"} : memref<32x32xi32>
  %119 = AIE.buffer(%110) {sym_name = "buf46"} : memref<32x32xi32>
  %120 = AIE.core(%110) {
  ...
  %124 = AIE.lock(%122, 1)
  %125 = AIE.lock(%122, 0)
  %126 = AIE.buffer(%122) {sym_name = "buf47"} : memref<32x32xi32>
  %127 = AIE.buffer(%122) {sym_name = "buf48"} : memref<32x32xi32>
  %128 = AIE.buffer(%122) {sym_name = "buf49"} : memref<32x32xi32>
  %129 = AIE.buffer(%122) {sym_name = "buf50"} : memref<32x32xi32>
  %130 = AIE.core(%122) {
  ...
  %133 = AIE.switchbox(%132) {
    ...
    %380 = AIE.masterset(DMA : 0, %379)
    %381 = AIE.masterset(DMA : 1, %377)
    %382 = AIE.masterset(North : 0, %376)
    %383 = AIE.masterset(North : 1, %378)
    AIE.packetrules(South : 1) {
      AIE.rule(31, 5, %379)
      AIE.rule(31, 6, %378)
    }
  ...
  %135 = AIE.lock(%132, 1)
  %136 = AIE.lock(%132, 0)
  %137 = AIE.buffer(%132) {sym_name = "buf51"} : memref<32x32xi32>
  %138 = AIE.buffer(%132) {sym_name = "buf52"} : memref<32x32xi32>
  %139 = AIE.buffer(%132) {sym_name = "buf53"} : memref<32x32xi32>
  %140 = AIE.core(%132) {
  ...
  %144 = AIE.switchbox(%142) {
    ...
    %381 = AIE.masterset(DMA : 0, %376)
    %382 = AIE.masterset(DMA : 1, %377)
    %383 = AIE.masterset(West : 0, %379)
    %384 = AIE.masterset(West : 1, %378)
    %385 = AIE.masterset(West : 2, %380)
    AIE.packetrules(East : 2) {
      AIE.rule(31, 0, %380)
    }
    AIE.packetrules(East : 1) {
  ...
  %147 = AIE.lock(%142, 1)
  %148 = AIE.lock(%142, 0)
  %149 = AIE.buffer(%142) {sym_name = "buf54"} : memref<32x32xi32>
  %150 = AIE.buffer(%142) {sym_name = "buf55"} : memref<32x32xi32>
  %151 = AIE.buffer(%142) {sym_name = "buf56"} : memref<32x32xi32>
  %152 = AIE.core(%142) {
  ...
  %156 = AIE.lock(%154, 1)
  %157 = AIE.lock(%154, 0)
  %158 = AIE.buffer(%154) {sym_name = "buf57"} : memref<32x32xi32>
  %159 = AIE.buffer(%154) {sym_name = "buf58"} : memref<32x32xi32>
  %160 = AIE.buffer(%154) {sym_name = "buf59"} : memref<32x32xi32>
  %161 = AIE.buffer(%154) {sym_name = "buf60"} : memref<32x32xi32>
  %162 = AIE.core(%154) {
  ...
  %165 = AIE.switchbox(%164) {
    ...
    %378 = AIE.amsel<0> (2)
    %379 = AIE.amsel<0> (3)
    %380 = AIE.masterset(DMA : 0, %376)
    %381 = AIE.masterset(DMA : 1, %379)
    %382 = AIE.masterset(North : 0, %378)
    %383 = AIE.masterset(North : 1, %377)
    AIE.packetrules(South : 1) {
      AIE.rule(31, 1, %376)
      AIE.rule(31, 2, %377)
    }
  ...
  %167 = AIE.lock(%164, 1)
  %168 = AIE.lock(%164, 0)
  %169 = AIE.buffer(%164) {sym_name = "buf61"} : memref<32x32xi32>
  %170 = AIE.buffer(%164) {sym_name = "buf62"} : memref<32x32xi32>
  %171 = AIE.buffer(%164) {sym_name = "buf63"} : memref<32x32xi32>
  %172 = AIE.core(%164) {
  ...
  %176 = AIE.switchbox(%174) {
    ...
    %379 = AIE.amsel<0> (2)
    %380 = AIE.amsel<0> (3)
    %381 = AIE.masterset(DMA : 0, %380)
    %382 = AIE.masterset(DMA : 1, %376)
    %383 = AIE.masterset(West : 0, %377)
    %384 = AIE.masterset(West : 1, %378)
    %385 = AIE.masterset(West : 2, %379)
    AIE.packetrules(East : 1) {
      AIE.rule(31, 0, %379)
    }
    AIE.packetrules(East : 0) {
  ...
  %179 = AIE.lock(%174, 1)
  %180 = AIE.lock(%174, 0)
  %181 = AIE.buffer(%174) {sym_name = "buf64"} : memref<32x32xi32>
  %182 = AIE.buffer(%174) {sym_name = "buf65"} : memref<32x32xi32>
  %183 = AIE.buffer(%174) {sym_name = "buf66"} : memref<32x32xi32>
  %184 = AIE.core(%174) {
  ...
  %188 = AIE.lock(%186, 1)
  %189 = AIE.lock(%186, 0)
  %190 = AIE.buffer(%186) {sym_name = "buf67"} : memref<32x32xi32>
  %191 = AIE.buffer(%186) {sym_name = "buf68"} : memref<32x32xi32>
  %192 = AIE.buffer(%186) {sym_name = "buf69"} : memref<32x32xi32>
  %193 = AIE.buffer(%186) {sym_name = "buf70"} : memref<32x32xi32>
  %194 = AIE.core(%186) {
  ...
  %199 = AIE.lock(%196, 1)
  %200 = AIE.lock(%196, 0)
  %201 = AIE.buffer(%196) {sym_name = "buf71"} : memref<32x32xi32>
  %202 = AIE.buffer(%196) {sym_name = "buf72"} : memref<32x32xi32>
  %203 = AIE.buffer(%196) {sym_name = "buf73"} : memref<32x32xi32>
  %204 = AIE.core(%196) {
  ...
  %208 = AIE.switchbox(%206) {
    ...
    %378 = AIE.amsel<0> (2)
    %379 = AIE.amsel<0> (3)
    %380 = AIE.masterset(DMA : 0, %377)
    %381 = AIE.masterset(DMA : 1, %379)
    %382 = AIE.masterset(West : 0, %376)
    %383 = AIE.masterset(West : 1, %378)
    AIE.packetrules(East : 1) {
      AIE.rule(31, 0, %378)
    }
    AIE.packetrules(East : 0) {
  ...
  %211 = AIE.lock(%206, 1)
  %212 = AIE.lock(%206, 0)
  %213 = AIE.buffer(%206) {sym_name = "buf74"} : memref<32x32xi32>
  %214 = AIE.buffer(%206) {sym_name = "buf75"} : memref<32x32xi32>
  %215 = AIE.buffer(%206) {sym_name = "buf76"} : memref<32x32xi32>
  %216 = AIE.core(%206) {
  ...
  %220 = AIE.lock(%218, 1)
  %221 = AIE.lock(%218, 0)
  %222 = AIE.buffer(%218) {sym_name = "buf77"} : memref<32x32xi32>
  %223 = AIE.buffer(%218) {sym_name = "buf78"} : memref<32x32xi32>
  %224 = AIE.buffer(%218) {sym_name = "buf79"} : memref<32x32xi32>
  %225 = AIE.buffer(%218) {sym_name = "buf80"} : memref<32x32xi32>
  %226 = AIE.core(%218) {
  ...
  %229 = AIE.switchbox(%228) {
    ...
    %379 = AIE.amsel<0> (3)
    %380 = AIE.masterset(DMA : 0, %378)
    %381 = AIE.masterset(DMA : 1, %376)
    %382 = AIE.masterset(North : 0, %379)
    %383 = AIE.masterset(North : 1, %377)
    AIE.packetrules(South : 1) {
      AIE.rule(31, 5, %378)
      AIE.rule(31, 6, %377)
  ...
  %231 = AIE.lock(%228, 1)
  %232 = AIE.lock(%228, 0)
  %233 = AIE.buffer(%228) {sym_name = "buf81"} : memref<32x32xi32>
  %234 = AIE.buffer(%228) {sym_name = "buf82"} : memref<32x32xi32>
  %235 = AIE.buffer(%228) {sym_name = "buf83"} : memref<32x32xi32>
  %236 = AIE.core(%228) {
  ...
  %240 = AIE.switchbox(%238) {
    ...
    %380 = AIE.masterset(DMA : 0, %378)
    %381 = AIE.masterset(DMA : 1, %379)
    %382 = AIE.masterset(West : 0, %377)
    %383 = AIE.masterset(West : 1, %376)
    AIE.packetrules(East : 1) {
      AIE.rule(31, 0, %376)
    }
    AIE.packetrules(East : 0) {
  ...
  %243 = AIE.lock(%238, 1)
  %244 = AIE.lock(%238, 0)
  %245 = AIE.buffer(%238) {sym_name = "buf84"} : memref<32x32xi32>
  %246 = AIE.buffer(%238) {sym_name = "buf85"} : memref<32x32xi32>
  %247 = AIE.buffer(%238) {sym_name = "buf86"} : memref<32x32xi32>
  %248 = AIE.core(%238) {
  ...
  %252 = AIE.lock(%250, 1)
  %253 = AIE.lock(%250, 0)
  %254 = AIE.buffer(%250) {sym_name = "buf87"} : memref<32x32xi32>
  %255 = AIE.buffer(%250) {sym_name = "buf88"} : memref<32x32xi32>
  %256 = AIE.buffer(%250) {sym_name = "buf89"} : memref<32x32xi32>
  %257 = AIE.buffer(%250) {sym_name = "buf90"} : memref<32x32xi32>
  %258 = AIE.core(%250) {
  ...
  %263 = AIE.lock(%260, 1)
  %264 = AIE.lock(%260, 0)
  %265 = AIE.buffer(%260) {sym_name = "buf91"} : memref<32x32xi32>
  %266 = AIE.buffer(%260) {sym_name = "buf92"} : memref<32x32xi32>
  %267 = AIE.buffer(%260) {sym_name = "buf93"} : memref<32x32xi32>
  %268 = AIE.core(%260) {
  ...
  %275 = AIE.lock(%270, 1)
  %276 = AIE.lock(%270, 0)
  %277 = AIE.buffer(%270) {sym_name = "buf94"} : memref<32x32xi32>
  %278 = AIE.buffer(%270) {sym_name = "buf95"} : memref<32x32xi32>
  %279 = AIE.buffer(%270) {sym_name = "buf96"} : memref<32x32xi32>
  %280 = AIE.core(%270) {
  ...
  %284 = AIE.lock(%282, 1)
  %285 = AIE.lock(%282, 0)
  %286 = AIE.buffer(%282) {sym_name = "buf97"} : memref<32x32xi32>
  %287 = AIE.buffer(%282) {sym_name = "buf98"} : memref<32x32xi32>
  %288 = AIE.buffer(%282) {sym_name = "buf99"} : memref<32x32xi32>
  %289 = AIE.buffer(%282) {sym_name = "buf100"} : memref<32x32xi32>
  %290 = AIE.core(%282) {
  ...
  %295 = AIE.lock(%292, 1)
  %296 = AIE.lock(%292, 0)
  %297 = AIE.buffer(%292) {sym_name = "buf101"} : memref<32x32xi32>
  %298 = AIE.buffer(%292) {sym_name = "buf102"} : memref<32x32xi32>
  %299 = AIE.buffer(%292) {sym_name = "buf103"} : memref<32x32xi32>
  %300 = AIE.core(%292) {
  ...
  %307 = AIE.lock(%302, 1)
  %308 = AIE.lock(%302, 0)
  %309 = AIE.buffer(%302) {sym_name = "buf104"} : memref<32x32xi32>
  %310 = AIE.buffer(%302) {sym_name = "buf105"} : memref<32x32xi32>
  %311 = AIE.buffer(%302) {sym_name = "buf106"} : memref<32x32xi32>
  %312 = AIE.core(%302) {
  ...
  %316 = AIE.lock(%314, 1)
  %317 = AIE.lock(%314, 0)
  %318 = AIE.buffer(%314) {sym_name = "buf107"} : memref<32x32xi32>
  %319 = AIE.buffer(%314) {sym_name = "buf108"} : memref<32x32xi32>
  %320 = AIE.buffer(%314) {sym_name = "buf109"} : memref<32x32xi32>
  %321 = AIE.buffer(%314) {sym_name = "buf110"} : memref<32x32xi32>
  %322 = AIE.core(%314) {
  ...
  %327 = AIE.lock(%324, 1)
  %328 = AIE.lock(%324, 0)
  %329 = AIE.buffer(%324) {sym_name = "buf111"} : memref<32x32xi32>
  %330 = AIE.buffer(%324) {sym_name = "buf112"} : memref<32x32xi32>
  %331 = AIE.buffer(%324) {sym_name = "buf113"} : memref<32x32xi32>
  %332 = AIE.core(%324) {
  ...
  %336 = AIE.switchbox(%334) {
    ...
    %377 = AIE.amsel<0> (1)
    %378 = AIE.amsel<0> (2)
    %379 = AIE.masterset(DMA : 0, %376)
    %380 = AIE.masterset(DMA : 1, %378)
    %381 = AIE.masterset(West : 0, %377)
    AIE.packetrules(DMA : 0) {
      AIE.rule(31, 0, %377)
    }
    AIE.packetrules(South : 1) {
  ...
  %339 = AIE.lock(%334, 1)
  %340 = AIE.lock(%334, 0)
  %341 = AIE.buffer(%334) {sym_name = "buf114"} : memref<32x32xi32>
  %342 = AIE.buffer(%334) {sym_name = "buf115"} : memref<32x32xi32>
  %343 = AIE.buffer(%334) {sym_name = "buf116"} : memref<32x32xi32>
  %344 = AIE.core(%334) {
  ...
  %347 = AIE.switchbox(%346) {
    ...
    %378 = AIE.amsel<0> (2)
    %379 = AIE.amsel<0> (3)
    %380 = AIE.masterset(North : 0, %379)
    %381 = AIE.masterset(North : 1, %376)
    %382 = AIE.masterset(East : 0, %377)
    %383 = AIE.masterset(East : 1, %378)
    %384 = AIE.masterset(East : 2, %376)
  ...
  %349 = AIE.switchbox(%348) {
    ...
    %378 = AIE.amsel<0> (2)
    %379 = AIE.amsel<0> (3)
    %380 = AIE.masterset(North : 0, %377)
    %381 = AIE.masterset(North : 1, %379)
    %382 = AIE.masterset(East : 0, %377)
    %383 = AIE.masterset(East : 1, %378)
    %384 = AIE.masterset(East : 2, %376)
    AIE.packetrules(West : 2) {
  ...
  %351 = AIE.switchbox(%350) {
    %376 = AIE.amsel<0> (0)
    %377 = AIE.amsel<0> (1)
    %378 = AIE.masterset(North : 0, %376)
    %379 = AIE.masterset(North : 1, %377)
    AIE.packetrules(South : 1) {
      AIE.rule(31, 4, %377)
      AIE.rule(31, 5, %377)
      AIE.rule(31, 6, %377)
  ...
  %353 = AIE.switchbox(%352) {
    %376 = AIE.amsel<0> (0)
    %377 = AIE.amsel<0> (1)
    %378 = AIE.masterset(North : 0, %377)
    %379 = AIE.masterset(North : 1, %376)
    AIE.packetrules(South : 1) {
      AIE.rule(31, 4, %376)
      AIE.rule(31, 5, %376)
      AIE.rule(31, 6, %376)
  ...
  %355 = AIE.switchbox(%354) {
    ...
    %378 = AIE.amsel<0> (2)
    %379 = AIE.amsel<0> (3)
    %380 = AIE.masterset(West : 0, %376)
    %381 = AIE.masterset(West : 1, %378)
    %382 = AIE.masterset(North : 0, %378)
    %383 = AIE.masterset(North : 1, %379)
    %384 = AIE.masterset(East : 0, %377)
    AIE.packetrules(West : 1) {
  ...
  %357 = AIE.switchbox(%356) {
    ...
    %382 = AIE.masterset(North : 0, %379)
    %383 = AIE.masterset(North : 1, %376)
    %384 = AIE.masterset(East : 0, %380)
    %385 = AIE.masterset(East : 1, %378)
    AIE.packetrules(West : 2) {
      AIE.rule(31, 4, %378)
      AIE.rule(31, 5, %378)
      AIE.rule(31, 6, %378)
  ...
  %359 = AIE.switchbox(%358) {
    ...
    %378 = AIE.amsel<0> (2)
    %379 = AIE.amsel<0> (3)
    %380 = AIE.masterset(West : 0, %378)
    %381 = AIE.masterset(North : 0, %378)
    %382 = AIE.masterset(North : 1, %379)
    %383 = AIE.masterset(East : 0, %376)
    %384 = AIE.masterset(East : 1, %379)
    %385 = AIE.masterset(East : 2, %377)
    AIE.packetrules(West : 2) {
      AIE.rule(31, 4, %377)
      AIE.rule(31, 5, %377)
      AIE.rule(31, 6, %377)
  ...
  %363 = AIE.switchbox(%362) {
    ...
    %380 = AIE.masterset(West : 0, %378)
    %381 = AIE.masterset(North : 0, %378)
    %382 = AIE.masterset(North : 1, %377)
    %383 = AIE.masterset(East : 0, %379)
    %384 = AIE.masterset(East : 1, %376)
    %385 = AIE.masterset(East : 2, %377)
    AIE.packetrules(West : 2) {
      AIE.rule(31, 4, %377)
      AIE.rule(31, 5, %377)
  ...
  %365 = AIE.switchbox(%364) {
    ...
    %377 = AIE.amsel<0> (1)
    %378 = AIE.amsel<0> (2)
    %379 = AIE.masterset(South : 0, %378)
    %380 = AIE.masterset(North : 0, %376)
    %381 = AIE.masterset(North : 1, %377)
    AIE.packetrules(North : 0) {
      AIE.rule(31, 0, %378)
    }
    AIE.packetrules(South : 1) {
  ...
  %375 = AIE.switchbox(%374) {
    ...
    %378 = AIE.amsel<0> (2)
    %379 = AIE.amsel<0> (3)
    %380 = AIE.masterset(South : 0, %376)
    %381 = AIE.masterset(South : 1, %378)
    %382 = AIE.masterset(North : 0, %379)
    %383 = AIE.masterset(North : 1, %377)
    AIE.packetrules(North : 1) {
      AIE.rule(31, 3, %378)
