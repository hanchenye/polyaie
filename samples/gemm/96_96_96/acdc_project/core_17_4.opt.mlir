module @gemm attributes {llvm.data_layout = "", llvm.target_triple = "aie"} {
  ...
  llvm.func @core174() {
    ...
    %5 = llvm.mlir.constant(19 : i32) : i32
    %6 = llvm.mlir.constant(17 : i32) : i32
    %7 = llvm.mlir.addressof @buf104 : !llvm.ptr<array<32 x array<32 x i32>>>
    ...
    %14 = llvm.mlir.addressof @buf105 : !llvm.ptr<array<32 x array<32 x i32>>>
    ...
    %19 = llvm.mlir.addressof @buf106 : !llvm.ptr<array<32 x array<32 x i32>>>
    ...
    %24 = llvm.mlir.addressof @buf114 : !llvm.ptr<array<32 x array<32 x i32>>>
    ...
    %29 = llvm.mlir.addressof @buf115 : !llvm.ptr<array<32 x array<32 x i32>>>
    ...
    %34 = llvm.mlir.addressof @buf116 : !llvm.ptr<array<32 x array<32 x i32>>>
    ...
    %39 = llvm.mlir.addressof @buf101 : !llvm.ptr<array<32 x array<32 x i32>>>
    ...
    %44 = llvm.mlir.addressof @buf102 : !llvm.ptr<array<32 x array<32 x i32>>>
    %45 = llvm.getelementptr %44[%8, %8, %8] : (!llvm.ptr<array<32 x array<32 x i32>>>, i64, i64, i64) -> !llvm.ptr<i32>
    %46 = llvm.ptrtoint %45 : !llvm.ptr<i32> to i64
    %47 = llvm.and %46, %10  : i64
    %48 = llvm.icmp "eq" %47, %8 : i64
    "llvm.intr.assume"(%48) : (i1) -> ()
    %49 = llvm.mlir.addressof @buf103 : !llvm.ptr<array<32 x array<32 x i32>>>
    %50 = llvm.getelementptr %49[%8, %8, %8] : (!llvm.ptr<array<32 x array<32 x i32>>>, i64, i64, i64) -> !llvm.ptr<i32>
    %51 = llvm.ptrtoint %50 : !llvm.ptr<i32> to i64
    %52 = llvm.and %51, %10  : i64
    ...
    llvm.call @extern_kernel(%40, %9, %15, %20) : (!llvm.ptr<i32>, !llvm.ptr<i32>, !llvm.ptr<i32>, !llvm.ptr<i32>) -> ()
