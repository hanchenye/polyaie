module @gemm attributes {llvm.target_triple = "aie"} {
  ...
  func @core184() {
    ...
    %3 = memref.get_global @buf111 : memref<32x32xi32>
    memref.assume_alignment %3, 32 : memref<32x32xi32>
    %4 = memref.get_global @buf112 : memref<32x32xi32>
    memref.assume_alignment %4, 32 : memref<32x32xi32>
    %5 = memref.get_global @buf113 : memref<32x32xi32>
    ...
    %6 = arith.index_cast %c16 : index to i32
    ...
    %8 = arith.index_cast %c18 : index to i32
