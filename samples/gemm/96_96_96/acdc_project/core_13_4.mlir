module @gemm attributes {llvm.target_triple = "aie"} {
  ...
  func @core134() {
    ...
    %6 = memref.get_global @buf64 : memref<32x32xi32>
    memref.assume_alignment %6, 32 : memref<32x32xi32>
    %7 = memref.get_global @buf65 : memref<32x32xi32>
    memref.assume_alignment %7, 32 : memref<32x32xi32>
    %8 = memref.get_global @buf66 : memref<32x32xi32>
    ...
    call @llvm.aie.lock.acquire.reg(%11, %c1_i32_1) : (i32, i32) -> ()
    %12 = arith.index_cast %c17 : index to i32
    %c0_i32 = arith.constant 0 : i32
    call @llvm.aie.lock.acquire.reg(%12, %c0_i32) : (i32, i32) -> ()
    call @extern_kernel(%3, %6, %7, %8) : (memref<32x32xi32>, memref<32x32xi32>, memref<32x32xi32>, memref<32x32xi32>) -> ()
    %13 = arith.index_cast %c17 : index to i32
    %c1_i32_2 = arith.constant 1 : i32
    call @llvm.aie.lock.release.reg(%13, %c1_i32_2) : (i32, i32) -> ()
    %14 = arith.index_cast %c18 : index to i32
    %c0_i32_3 = arith.constant 0 : i32
    call @llvm.aie.lock.release.reg(%14, %c0_i32_3) : (i32, i32) -> ()
