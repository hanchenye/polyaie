...
define void @core184() !dbg !3 {
  ...
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([32 x [32 x i32]]* @buf111 to i64), i64 31), i64 0)), !dbg !11
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([32 x [32 x i32]]* @buf112 to i64), i64 31), i64 0)), !dbg !12
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([32 x [32 x i32]]* @buf113 to i64), i64 31), i64 0)), !dbg !13
  call void @llvm.aie.lock.acquire.reg(i32 16, i32 1), !dbg !14
  call void @llvm.aie.lock.acquire.reg(i32 17, i32 1), !dbg !15
  call void @llvm.aie.lock.acquire.reg(i32 18, i32 1), !dbg !16
  call void @llvm.aie.lock.acquire.reg(i32 19, i32 0), !dbg !17
  call void @extern_kernel(i32* getelementptr inbounds ([32 x [32 x i32]], [32 x [32 x i32]]* @buf111, i64 0, i64 0, i64 0), i32* getelementptr inbounds ([32 x [32 x i32]], [32 x [32 x i32]]* @buf114, i64 0, i64 0, i64 0), i32* getelementptr inbounds ([32 x [32 x i32]], [32 x [32 x i32]]* @buf115, i64 0, i64 0, i64 0), i32* getelementptr inbounds ([32 x [32 x i32]], [32 x [32 x i32]]* @buf116, i64 0, i64 0, i64 0)), !dbg !18
  call void @llvm.aie.lock.release.reg(i32 19, i32 1), !dbg !19
  call void @llvm.aie.lock.release.reg(i32 18, i32 0), !dbg !20
  call void @llvm.aie.lock.release.reg(i32 17, i32 0), !dbg !21
...
!3 = distinct !DISubprogram(name: "core184", linkageName: "core184", scope: null, file: !4, line: 20, type: !5, scopeLine: 20, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !6)
!4 = !DIFile(filename: "acdc_project/core_18_4.opt.mlir", directory: "/proj/rdi/staff/jinmingz/nobkup/polyaie/samples/gemm/96_96_96")
