module @gemm attributes {llvm.target_triple = "aie"} {
  ...
  memref.global "public" @buf47 : memref<32x32xi32>
  memref.global "public" @buf48 : memref<32x32xi32>
  memref.global "public" @buf49 : memref<32x32xi32>
  memref.global "public" @buf50 : memref<32x32xi32>
  memref.global "public" @buf54 : memref<32x32xi32>
  memref.global "public" @buf55 : memref<32x32xi32>
  memref.global "public" @buf56 : memref<32x32xi32>
  ...
  func @core123() {
    %0 = memref.get_global @buf51 : memref<32x32xi32>
    memref.assume_alignment %0, 32 : memref<32x32xi32>
    %1 = memref.get_global @buf52 : memref<32x32xi32>
    memref.assume_alignment %1, 32 : memref<32x32xi32>
    %2 = memref.get_global @buf53 : memref<32x32xi32>
    memref.assume_alignment %2, 32 : memref<32x32xi32>
    %3 = memref.get_global @buf41 : memref<32x32xi32>
    memref.assume_alignment %3, 32 : memref<32x32xi32>
    %4 = memref.get_global @buf42 : memref<32x32xi32>
    memref.assume_alignment %4, 32 : memref<32x32xi32>
    %5 = memref.get_global @buf43 : memref<32x32xi32>
    memref.assume_alignment %5, 32 : memref<32x32xi32>
    %6 = memref.get_global @buf54 : memref<32x32xi32>
    memref.assume_alignment %6, 32 : memref<32x32xi32>
    %7 = memref.get_global @buf55 : memref<32x32xi32>
    memref.assume_alignment %7, 32 : memref<32x32xi32>
    %8 = memref.get_global @buf56 : memref<32x32xi32>
    memref.assume_alignment %8, 32 : memref<32x32xi32>
    %9 = memref.get_global @buf47 : memref<32x32xi32>
    memref.assume_alignment %9, 32 : memref<32x32xi32>
    %10 = memref.get_global @buf48 : memref<32x32xi32>
    memref.assume_alignment %10, 32 : memref<32x32xi32>
    %11 = memref.get_global @buf49 : memref<32x32xi32>
    memref.assume_alignment %11, 32 : memref<32x32xi32>
    %12 = memref.get_global @buf50 : memref<32x32xi32>
    ...
    call @extern_kernel(%9, %0, %1, %2) : (memref<32x32xi32>, memref<32x32xi32>, memref<32x32xi32>, memref<32x32xi32>) -> ()
    %17 = arith.index_cast %c33 : index to i32
    %c1_i32_2 = arith.constant 1 : i32
    call @llvm.aie.lock.release.reg(%17, %c1_i32_2) : (i32, i32) -> ()
    %18 = arith.index_cast %c49 : index to i32
    ...
    %20 = arith.index_cast %c48 : index to i32
