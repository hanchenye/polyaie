module @gemm attributes {llvm.target_triple = "aie"} {
  ...
  func @core164() {
    %0 = memref.get_global @buf94 : memref<32x32xi32>
    memref.assume_alignment %0, 32 : memref<32x32xi32>
    %1 = memref.get_global @buf95 : memref<32x32xi32>
    memref.assume_alignment %1, 32 : memref<32x32xi32>
    %2 = memref.get_global @buf96 : memref<32x32xi32>
    ...
    %6 = memref.get_global @buf91 : memref<32x32xi32>
    memref.assume_alignment %6, 32 : memref<32x32xi32>
    %7 = memref.get_global @buf92 : memref<32x32xi32>
    memref.assume_alignment %7, 32 : memref<32x32xi32>
    %8 = memref.get_global @buf93 : memref<32x32xi32>
    ...
    %12 = arith.index_cast %c19 : index to i32
    ...
    %15 = arith.index_cast %c17 : index to i32
