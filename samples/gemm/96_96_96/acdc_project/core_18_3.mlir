module @gemm attributes {llvm.target_triple = "aie"} {
  ...
  memref.global "public" @buf111 : memref<32x32xi32>
  memref.global "public" @buf112 : memref<32x32xi32>
  memref.global "public" @buf113 : memref<32x32xi32>
  ...
  memref.global "public" @buf114 : memref<32x32xi32>
  memref.global "public" @buf115 : memref<32x32xi32>
  memref.global "public" @buf116 : memref<32x32xi32>
  func @core183() {
    %0 = memref.get_global @buf114 : memref<32x32xi32>
    memref.assume_alignment %0, 32 : memref<32x32xi32>
    %1 = memref.get_global @buf115 : memref<32x32xi32>
    memref.assume_alignment %1, 32 : memref<32x32xi32>
    %2 = memref.get_global @buf116 : memref<32x32xi32>
    memref.assume_alignment %2, 32 : memref<32x32xi32>
    %3 = memref.get_global @buf101 : memref<32x32xi32>
    memref.assume_alignment %3, 32 : memref<32x32xi32>
    %4 = memref.get_global @buf102 : memref<32x32xi32>
    memref.assume_alignment %4, 32 : memref<32x32xi32>
    %5 = memref.get_global @buf103 : memref<32x32xi32>
    memref.assume_alignment %5, 32 : memref<32x32xi32>
    %6 = memref.get_global @buf107 : memref<32x32xi32>
    memref.assume_alignment %6, 32 : memref<32x32xi32>
    %7 = memref.get_global @buf108 : memref<32x32xi32>
    memref.assume_alignment %7, 32 : memref<32x32xi32>
    %8 = memref.get_global @buf109 : memref<32x32xi32>
    memref.assume_alignment %8, 32 : memref<32x32xi32>
    %9 = memref.get_global @buf110 : memref<32x32xi32>
    memref.assume_alignment %9, 32 : memref<32x32xi32>
    %10 = memref.get_global @buf111 : memref<32x32xi32>
    memref.assume_alignment %10, 32 : memref<32x32xi32>
    %11 = memref.get_global @buf112 : memref<32x32xi32>
    memref.assume_alignment %11, 32 : memref<32x32xi32>
    %12 = memref.get_global @buf113 : memref<32x32xi32>
    ...
    %14 = arith.index_cast %c33 : index to i32
    ...
    call @extern_kernel(%6, %10, %11, %12) : (memref<32x32xi32>, memref<32x32xi32>, memref<32x32xi32>, memref<32x32xi32>) -> ()
    ...
    %19 = arith.index_cast %c33 : index to i32
