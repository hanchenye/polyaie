...
define void @core174() !dbg !3 {
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([32 x [32 x i32]]* @buf104 to i64), i64 31), i64 0)), !dbg !7
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([32 x [32 x i32]]* @buf105 to i64), i64 31), i64 0)), !dbg !9
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([32 x [32 x i32]]* @buf106 to i64), i64 31), i64 0)), !dbg !10
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([32 x [32 x i32]]* @buf114 to i64), i64 31), i64 0)), !dbg !11
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([32 x [32 x i32]]* @buf115 to i64), i64 31), i64 0)), !dbg !12
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([32 x [32 x i32]]* @buf116 to i64), i64 31), i64 0)), !dbg !13
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([32 x [32 x i32]]* @buf101 to i64), i64 31), i64 0)), !dbg !14
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([32 x [32 x i32]]* @buf102 to i64), i64 31), i64 0)), !dbg !15
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([32 x [32 x i32]]* @buf103 to i64), i64 31), i64 0)), !dbg !16
  call void @llvm.aie.lock.acquire.reg(i32 18, i32 1), !dbg !17
  call void @llvm.aie.lock.acquire.reg(i32 16, i32 1), !dbg !18
  call void @llvm.aie.lock.acquire.reg(i32 19, i32 0), !dbg !19
  call void @llvm.aie.lock.acquire.reg(i32 17, i32 1), !dbg !20
  call void @extern_kernel(i32* getelementptr inbounds ([32 x [32 x i32]], [32 x [32 x i32]]* @buf101, i64 0, i64 0, i64 0), i32* getelementptr inbounds ([32 x [32 x i32]], [32 x [32 x i32]]* @buf104, i64 0, i64 0, i64 0), i32* getelementptr inbounds ([32 x [32 x i32]], [32 x [32 x i32]]* @buf105, i64 0, i64 0, i64 0), i32* getelementptr inbounds ([32 x [32 x i32]], [32 x [32 x i32]]* @buf106, i64 0, i64 0, i64 0)), !dbg !21
  call void @llvm.aie.lock.release.reg(i32 17, i32 0), !dbg !22
  call void @llvm.aie.lock.release.reg(i32 19, i32 1), !dbg !23
  call void @llvm.aie.lock.release.reg(i32 16, i32 0), !dbg !24
  call void @llvm.aie.lock.release.reg(i32 18, i32 0), !dbg !25
  call void @llvm.aie.lock.release.reg(i32 31, i32 1), !dbg !26
  ret void, !dbg !27
}

define void @_main() !dbg !28 {
  call void @core174(), !dbg !29
  ret void, !dbg !31
}
...
!3 = distinct !DISubprogram(name: "core174", linkageName: "core174", scope: null, file: !4, line: 23, type: !5, scopeLine: 23, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !6)
!4 = !DIFile(filename: "acdc_project/core_17_4.opt.mlir", directory: "/proj/rdi/staff/jinmingz/nobkup/polyaie/samples/gemm/96_96_96")
