module @gemm attributes {llvm.target_triple = "aie"} {
  ...
  func @core103() {
    %0 = memref.get_global @buf34 : memref<32x32xi32>
    memref.assume_alignment %0, 32 : memref<32x32xi32>
    %1 = memref.get_global @buf35 : memref<32x32xi32>
    memref.assume_alignment %1, 32 : memref<32x32xi32>
    %2 = memref.get_global @buf36 : memref<32x32xi32>
    memref.assume_alignment %2, 32 : memref<32x32xi32>
    %3 = memref.get_global @buf27 : memref<32x32xi32>
    memref.assume_alignment %3, 32 : memref<32x32xi32>
    %4 = memref.get_global @buf28 : memref<32x32xi32>
    memref.assume_alignment %4, 32 : memref<32x32xi32>
    %5 = memref.get_global @buf29 : memref<32x32xi32>
    memref.assume_alignment %5, 32 : memref<32x32xi32>
    %6 = memref.get_global @buf30 : memref<32x32xi32>
    memref.assume_alignment %6, 32 : memref<32x32xi32>
    %7 = memref.get_global @buf31 : memref<32x32xi32>
    memref.assume_alignment %7, 32 : memref<32x32xi32>
    %8 = memref.get_global @bui32 : memref<32x32xi32>
    memref.assume_alignment %8, 32 : memref<32x32xi32>
    %9 = memref.get_global @buf33 : memref<32x32xi32>
    ...
    %10 = arith.index_cast %c34 : index to i32
    ...
    call @extern_kernel(%3, %7, %8, %9) : (memref<32x32xi32>, memref<32x32xi32>, memref<32x32xi32>, memref<32x32xi32>) -> ()
    ...
    %17 = arith.index_cast %c34 : index to i32
    %c1_i32_5 = arith.constant 1 : i32
    call @llvm.aie.lock.release.reg(%17, %c1_i32_5) : (i32, i32) -> ()
    return
  }
  func @_main() {
    call @core103() : () -> ()
