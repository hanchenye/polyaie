...
define void @core262() !dbg !3 {
  ...
  call void @llvm.aie.lock.acquire.reg(i32 34, i32 0), !dbg !17
  ...
  call void @llvm.aie.lock.release.reg(i32 34, i32 1), !dbg !19
...
!4 = !DIFile(filename: "acdc_project/core_26_2.opt.mlir", directory: "/proj/rdi/staff/jinmingz/nobkup/polyaie/samples/gemm/32_64_32/test_gen")
