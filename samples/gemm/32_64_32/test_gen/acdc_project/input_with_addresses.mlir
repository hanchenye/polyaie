module @gemm {
  ...
  %2 = AIE.switchbox(%0) {
    %37 = AIE.amsel<0> (0)
    %38 = AIE.amsel<0> (1)
    %39 = AIE.masterset(South : 2, %38)
    %40 = AIE.masterset(North : 0, %37)
  ...
  %14 = AIE.switchbox(%13) {
    ...
    %39 = AIE.amsel<0> (2)
    %40 = AIE.amsel<0> (3)
    %41 = AIE.masterset(DMA : 0, %39)
    %42 = AIE.masterset(DMA : 1, %40)
    %43 = AIE.masterset(South : 0, %38)
    %44 = AIE.masterset(North : 0, %37)
    AIE.packetrules(North : 0) {
      AIE.rule(31, 0, %38)
    }
  ...
  %36 = AIE.switchbox(%35) {
    %37 = AIE.amsel<0> (0)
    %38 = AIE.amsel<0> (1)
    %39 = AIE.masterset(South : 0, %37)
    %40 = AIE.masterset(North : 0, %38)
    AIE.packetrules(North : 0) {
      AIE.rule(31, 0, %37)
    }
    AIE.packetrules(South : 0) {
