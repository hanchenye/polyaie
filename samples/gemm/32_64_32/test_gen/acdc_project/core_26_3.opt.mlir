module @gemm attributes {llvm.data_layout = "", llvm.target_triple = "aie"} {
  ...
  llvm.func @core263() {
    ...
    %7 = llvm.mlir.addressof @buf5 : !llvm.ptr<array<32 x array<32 x i32>>>
    ...
    %14 = llvm.mlir.addressof @buf6 : !llvm.ptr<array<32 x array<32 x i32>>>
    ...
    %19 = llvm.mlir.addressof @buf7 : !llvm.ptr<array<32 x array<32 x i32>>>
    ...
    %24 = llvm.mlir.addressof @buf8 : !llvm.ptr<array<32 x array<32 x i32>>>
    ...
    %29 = llvm.mlir.addressof @buf9 : !llvm.ptr<array<32 x array<32 x i32>>>
    ...
    %34 = llvm.mlir.addressof @buf10 : !llvm.ptr<array<32 x array<32 x i32>>>
    ...
    %39 = llvm.mlir.addressof @buf11 : !llvm.ptr<array<32 x array<32 x i32>>>
    ...
    llvm.call @extern_kernel(%9, %30, %35, %40) : (!llvm.ptr<i32>, !llvm.ptr<i32>, !llvm.ptr<i32>, !llvm.ptr<i32>) -> ()
