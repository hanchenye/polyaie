...
void mlir_aie_configure_dmas(aie_libxaie_ctx_t *ctx) {
  ...
  XAieDma_ShimBdSetLock(&ShimDMAInst_26_0, /* bd */ 1, /* lockID */ 1,
  ...
  XAieDma_ShimBdSetLock(&ShimDMAInst_26_0, /* bd */ 2, /* lockID */ 3,
                        XAIE_ENABLE, /* release */ 0, XAIE_ENABLE,
                        /* acquire */ 1);
  ...
  XAieDma_ShimBdSetLock(&ShimDMAInst_26_0, /* bd */ 3, /* lockID */ 0,
                        XAIE_ENABLE, /* release */ 0, XAIE_ENABLE,
                        /* acquire */ 1);
  ...
  XAieDma_ShimBdSetLock(&ShimDMAInst_26_0, /* bd */ 4, /* lockID */ 2,
                        XAIE_ENABLE, /* release */ 0, XAIE_ENABLE,
                        /* acquire */ 1);
...
void mlir_aie_configure_switchboxes(aie_libxaie_ctx_t *ctx) {
  ...
  XAieTile_StrmConfigSlvSlot(
      ...
      XAIETILE_STRSW_SLVSLOT_CFG(
          &(ctx->TileInst[x][y]),
          (XAIETILE_STRSW_SPORT_SOUTH(&(ctx->TileInst[x][y]), 0)), 0 /*slot*/,
          0x0 /*ID value*/, 0x1E /*mask*/, XAIE_ENABLE, 2 /*msel*/,
          0 /*arbiter*/));
