module @gemm {
  ...
  %2 = AIE.switchbox(%0) {
    ...
    %281 = AIE.amsel<0> (1)
    %282 = AIE.amsel<0> (2)
    %283 = AIE.masterset(South : 2, %281)
    %284 = AIE.masterset(North : 0, %280)
    %285 = AIE.masterset(North : 1, %282)
  ...
  %14 = AIE.switchbox(%13) {
    ...
    %283 = AIE.amsel<0> (2)
    %284 = AIE.amsel<0> (3)
    %285 = AIE.masterset(DMA : 0, %283)
    %286 = AIE.masterset(DMA : 1, %282)
    %287 = AIE.masterset(South : 0, %280)
    %288 = AIE.masterset(North : 0, %281)
    %289 = AIE.masterset(North : 1, %284)
    AIE.packetrules(North : 0) {
      AIE.rule(31, 0, %280)
    }
  ...
  %25 = AIE.switchbox(%23) {
    ...
    %281 = AIE.amsel<0> (1)
    %282 = AIE.amsel<0> (2)
    %283 = AIE.masterset(DMA : 0, %281)
    %284 = AIE.masterset(DMA : 1, %280)
    %285 = AIE.masterset(South : 0, %282)
  ...
  %36 = AIE.switchbox(%35) {
    ...
    %281 = AIE.amsel<0> (1)
    %282 = AIE.amsel<0> (2)
    %283 = AIE.masterset(South : 0, %281)
    %284 = AIE.masterset(North : 0, %282)
    %285 = AIE.masterset(North : 1, %280)
    AIE.packetrules(North : 0) {
      AIE.rule(31, 0, %281)
    }
    AIE.packetrules(South : 1) {
