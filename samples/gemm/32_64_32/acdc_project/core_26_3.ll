...
define void @core263() !dbg !3 {
  ...
  call void @llvm.aie.lock.acquire.reg(i32 51, i32 1), !dbg !16
  call void @llvm.aie.lock.acquire.reg(i32 49, i32 1), !dbg !17
  ...
  call void @llvm.aie.lock.release.reg(i32 49, i32 0), !dbg !21
  call void @llvm.aie.lock.release.reg(i32 51, i32 0), !dbg !22
...
!4 = !DIFile(filename: "acdc_project/core_26_3.opt.mlir", directory: "/proj/rdi/staff/jinmingz/nobkup/polyaie/samples/gemm/32_64_32")
