module @gemm {
  ...
  %5 = AIE.lock(%0, 1)
  %6 = AIE.lock(%0, 0)
  %7 = AIE.external_buffer 0x020100000000 {sym_name = "buf0"} : memref<32x32xi32>
  %8 = AIE.external_buffer 0x020100001000 {sym_name = "buf1"} : memref<32x32xi32>
  %9 = AIE.external_buffer 0x020100002000 {sym_name = "buf2"} : memref<32x32xi32>
  %10 = AIE.external_buffer 0x020100003000 {sym_name = "buf3"} : memref<32x32xi32>
  %11 = AIE.external_buffer 0x020100004000 {sym_name = "buf4"} : memref<1025xi32>
  %13 = AIE.shimDMA(%0) {
