module @gemm {
  ...
  %2 = AIE.switchbox(%0) {
    ...
    %41 = AIE.amsel<0> (1)
    %42 = AIE.amsel<0> (2)
    %43 = AIE.masterset(South : 2, %41)
    %44 = AIE.masterset(North : 0, %40)
    %45 = AIE.masterset(North : 1, %42)
  ...
  %17 = AIE.switchbox(%16) {
    ...
    %43 = AIE.amsel<0> (2)
    %44 = AIE.amsel<0> (3)
    %45 = AIE.masterset(DMA : 0, %43)
    %46 = AIE.masterset(DMA : 1, %42)
    %47 = AIE.masterset(South : 0, %40)
    %48 = AIE.masterset(North : 0, %41)
    %49 = AIE.masterset(North : 1, %44)
    AIE.packetrules(North : 0) {
      AIE.rule(31, 0, %40)
    }
  ...
  %39 = AIE.switchbox(%38) {
    ...
    %41 = AIE.amsel<0> (1)
    %42 = AIE.amsel<0> (2)
    %43 = AIE.masterset(South : 0, %41)
    %44 = AIE.masterset(North : 0, %42)
    %45 = AIE.masterset(North : 1, %40)
    AIE.packetrules(North : 0) {
      AIE.rule(31, 0, %41)
    }
    AIE.packetrules(South : 1) {
