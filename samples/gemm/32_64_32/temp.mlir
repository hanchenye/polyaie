module @gemm {
  ...
  %5 = AIE.lock(%0, 1)
  %6 = AIE.lock(%0, 0)
  %7 = AIE.external_buffer 16384 {sym_name = "buf0"} : memref<32x32xf32>
  %8 = AIE.external_buffer 20480 {sym_name = "buf1"} : memref<32x32xf32>
  %9 = AIE.external_buffer 24576 {sym_name = "buf2"} : memref<32x32xf32>
  %10 = AIE.external_buffer 28672 {sym_name = "buf3"} : memref<32x32xf32>
  %11 = AIE.external_buffer 32768 {sym_name = "buf4"} : memref<1025xf32>
  %12 = AIE.core(%0) {
  ...
  %17 = AIE.switchbox(%16) {
    ...
    %42 = AIE.amsel<0> (2)
    %43 = AIE.amsel<0> (3)
    %44 = AIE.masterset(DMA : 0, %41)
    %45 = AIE.masterset(DMA : 1, %40)
    %46 = AIE.masterset(South : 0, %42)
  ...
  %18 = AIE.lock(%16, 1)
  %19 = AIE.lock(%16, 0)
  %20 = AIE.buffer(%16) {sym_name = "buf5"} : memref<32x32xf32>
  %21 = AIE.buffer(%16) {sym_name = "buf6"} : memref<32x32xf32>
  %22 = AIE.buffer(%16) {sym_name = "buf7"} : memref<32x32xf32>
  %23 = AIE.buffer(%16) {sym_name = "buf8"} : memref<32x32xf32>
  %24 = AIE.core(%16) {
  ...
  %28 = AIE.switchbox(%26) {
    ...
    %41 = AIE.amsel<0> (1)
    %42 = AIE.amsel<0> (2)
    %43 = AIE.masterset(DMA : 0, %41)
    %44 = AIE.masterset(DMA : 1, %42)
    %45 = AIE.masterset(South : 0, %40)
  ...
  %31 = AIE.lock(%26, 1)
  %32 = AIE.lock(%26, 0)
  %33 = AIE.buffer(%26) {sym_name = "buf9"} : memref<32x32xf32>
  %34 = AIE.buffer(%26) {sym_name = "buf10"} : memref<32x32xf32>
  %35 = AIE.buffer(%26) {sym_name = "buf11"} : memref<32x32xf32>
  %36 = AIE.core(%26) {
    AIE.useLock(%31, Acquire, 1)
    AIE.useLock(%29, Acquire, 1)
    AIE.useLock(%30, Acquire, 1)
    AIE.useLock(%32, Acquire, 0)
    call @extern_kernel(%20, %33, %34, %35) : (memref<32x32xf32>, memref<32x32xf32>, memref<32x32xf32>, memref<32x32xf32>) -> ()
