// RUN: polyaie-opt %s -polyaie-pipeline="top-func-name=kernel_2mm algorithm=simulated-annealing" | FileCheck %s
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @kernel_2mm__PE0__cloned_for__S2(%arg0: memref<16x24xf32>, %arg1: f32, %arg2: index, %arg3: index) attributes {scop.pe} {
  ...
  func @kernel_2mm__PE1(%arg0: memref<16x18xf32>, %arg1: memref<22x18xf32>, %arg2: f32, %arg3: memref<16x22xf32>, %arg4: index, %arg5: index, %arg6: index) attributes {scop.pe} {
  ...
  func @kernel_2mm__PE2(%arg0: memref<16x24xf32>, %arg1: memref<18x24xf32>, %arg2: memref<16x18xf32>, %arg3: index, %arg4: index, %arg5: index) attributes {scop.pe} {
    ...
    affine.for %arg11 = 0 to 1 {
      affine.for %arg12 = 0 to 1 {
        affine.for %arg13 = 0 to 1 {
          call @kernel_2mm__PE1(%arg6, %arg8, %arg4, %arg7, %arg12, %arg13, %arg11) {scop.pe} : (memref<16x18xf32>, memref<22x18xf32>, f32, memref<16x22xf32>, index, index, index) -> ()
        }
        affine.for %arg13 = 0 to 1 {
          call @kernel_2mm__PE2(%arg10, %arg9, %arg6, %arg13, %arg12, %arg11) {scop.pe} : (memref<16x24xf32>, memref<18x24xf32>, memref<16x18xf32>, index, index, index) -> ()
        }
      }
    }
    return
